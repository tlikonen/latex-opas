...
Peruskirjainperheen (\koodi{\keno setmainfont}) skaalaukseksi asetetaan
...
määrittämiseen.
\pagebreak[3]
Uusi perhe määritellään seuraavasti:
...
suhteellista tapaa koko\-asetuksiin. Suhteellisia ja absoluuttisia
koko\-ase\-tuk\-sia käsitellään luvuissa \ref{luku:fontti_suhteellinen}
ja \ref{luku:fontti_absoluuttinen}.
...
dokumenttiluokan fontti\-asetus oletukseksi (\koodi{10pt}) ja käyttää
koon asettamiseen luvussa \ref{luku:fontti_suhteellinen} tai
...
(\textbf{lihavoitu}) ja \koodi{\keno itshape} (\textit{kursiivi}), ja
...
ovat gemenat eli pien\-aak\-ko\-set (\koodi{MatchLowercase}). Näiden
kahden kirjainperheen pistekokoa ei tiedetä. Se ei välttämättä ole sama
kuin perusfontissa, koska fonttien pistekoko mitataan ylimmän ja alimman
