...
käsitellään luvussa \ref{luku:typo_liga}. Molemmat ligatuurityypit saa
pois päältä seuraavalla asetuksella:
...
Ainakin kirjatypografiassa on tavallista käyttää pääasiassa
...
\koodi{Numbers}, jos käytössä olevan fontti sisältää gemenanumerot.
...
kanssa, koska merkkien koko\-ero on turhan suuri (ei näin: ISO-8859\=/1,
UTF\=/16, A4). Gemenanumeroiden kanssa täytyy käyttää versaalikirjainten
sijasta pienversaalia, jota saadaan \koodi{\keno text\-sc}\-/komennolla:
\textsc{iso-8859\=/1}, \textsc{utf\=/16}, \textsc{a4}. Toinen vaihtoehto
on yhdistää versaalikirjaimet ja versaalinumerot: {\versaalinum
  ISO-8859\=/1, UTF\=/16, A4}.

Silloin kun käytetään numeroita teknisten koodien ilmaisemiseen, voi
olla tarpeen merkitä numero nolla poikkiviivalla
({\addfontfeatures{Numbers={Uppercase, SlashedZero}}0}), jotta se ei
...
\begin{koodilohkosis}
  ...
  Numbers=Proportional % vaihtelevan leveydet numerot (oletus)
\end{koodilohkosis}
