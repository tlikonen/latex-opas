...
niiden asetuksia. Omien dokumenttiluokkien tekemistä käsitellään luvussa
\ref{luku:omat_dokumenttiluokat}. Oman dokumenttiluokan tekeminen voi
olla hyödyllistä silloin, kun täytyy tuottaa paljon samantyylisiä
dokumentteja ja haluaa määrittää monet asetukset valmiiksi.
...
\koodieng{article}, \koodieng{report} tai \koodieng{book} avulla. Ne
ovat keskenään hyvin samanlaisia, mutta niiden oletusasetukset
poikkeavat toisistaan. Karkeasti jaoteltuna \koodieng{article}\-/luokka
on tarkoitettu lyhyehköille artikkeleille ja yleiseksi perustaksi
monenlaisille dokumenteille. Sen sijaan \koodieng{report} ja
\koodieng{book} on tarkoitettu laajoihin dokumentteihin, ja niissä on
...
sisältävät suuret pääluvut eli otsikot (\koodieng{\keno chapter}), jotka
...
\koodieng{book} välillä. Taulukkoon \ref{tlk:luokkavalitsimet} on koottu
perusdokumenttiluokkien valitsimet, ja niitä käsitellään seuraavaksi.
