...
Esimerkissä peruskirjainperheen (\koodi{setmainfont}) skaalaus on 1, eli
sille ei tehdä mitään, ja koko valitsimen voisi jättää pois. Sen sijaan
kahdella muulla kirjainperheellä (\koodi{setsansfont, setmonofont})
käytetään ker\-roin\-ase\-tus\-ta \koodi{MatchLowercase}, joka skaalaa
...
\koodi{\keno fontsize}\-/komentoa ja ladottu lopputulos. Komento
...
lasketaan myös kirjainperheen skaalauskerroin. Tämän vuoksi \koodi{\keno
  fontsize}\-/komennon käyttö menee aika oudoksi, ja sen voisi ehkä
hylätä kokonaan. Jos korkean tason font\-ti\-koko\-komen\-to\-jen
(taulukko \ref{tlk:fonttikokokomennot}) lisäksi tarvitaan jotakin muuta
kokoa, voisi käyttää Fontspec\-/paketin tarjoamaa komentoa ja
tilanteeseen sopivaa skaalauskerrointa esimerkiksi seuraavalla tavalla:
...
\begin{koodilohko}
  ...
  \newfontfamily{\abssans}{Linux Biolinum O}
  \newfontfamily{\absmono}{Linux Libertine Mono O}
...
Uusien kirjainperheiden komentojen nimiksi on valittu \koodi{\keno
  abssans} ja \koodi{\keno absmono}, ja näillä komennoilla
kirjainperheet kytketään päälle. Ne ovat ikään kun absoluuttisia
vastineita valmiille komennoille \koodi{\keno sffamily} ja \koodi{\keno
  ttfamily} (taulukko \ref{tlk:fonttimallikomennot}). Jos esimerkiksi
...
\koodi{\keno normalsize} mutta sen lisäksi kaikki ne, joita omassa
dokumentissa tarvitaan. Tässä esimerkissä normaali koko asetetaan
14\-/pisteiseksi ja muut koot pienentyvät tai suurentuvat siitä.
...
kokoluokalle. Rivikorkeuteen vaikuttaa myös kerroin \koodi{\keno
...
asetetaan aina \koodi{\keno fontsize}\-/komennolla.
