...
kirjainperheen varaan: antiikva eli pääteviivallinen\footnote{Antiikva
  (lat. \emph{antiquus} 'vanha') perustuu antiikin Roomassa käytettyihin
  kirjainmuotoihin. Ne olivat pääteviivallisia, mutta vaakasuorat
  pääteviivat sinänsä eivät ole ainoa antiikvan piirre. Toinen tärkeä
  ominaisuus ovat erivahvuiset viivat. Tämän oppaan groteskifontissakin
  on erivahvuiset viivat mutta pääteviivoja ei ole. Siten se on
  eräänlainen antiikvan ja groteskin välimuoto.} (\textenglish{serif,
  roman}), groteski eli pääteviivaton (\textenglish{sans serif, gothic})
...
(\koodi{\keno baselineskip}). Se on mitta rivin peruslinjalta edellisen
...
ja \koodi{\keno ttfamily}, taulukko \ref{tlk:fonttimallikomennot}), ja
