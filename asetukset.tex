...
\pakettim{fancyhdr}\avctan{fancyhdr} toimintojen avulla. Silloin
...
Valinnainen argumentti \koodil{paikka} kertoo, mihin paikkaan tai
paikkoihin \koodil{sisältö} sijoitetaan. Vaihtoehtoina on ylä- tai
...
\pakettim{hyperref}\-/ paketin\avctan{hyperref} avulla. Paketti
...
Komennon valinnainen argumentti \koodil{taso} on kokonaisluku, joka
tarkoittaa otsikon tasoa. Se tarkoittaa samaa tasonumeroa kuin
otsikkotasojen taulukossa \ref{tlk:otsikkotasot}
(s.~\pageref{tlk:otsikkotasot}). Argumentti \koodil{Teksti} on pdf:n
sisällysluettelomerkinnän teksti, ja \koodil{tunniste} on mikä tahansa
...
vielä \koodi{Scale\-Again}\-/ valitsimella seuraavaan tapaan:
...
\paketti{polyglossia}\avctan{polyglossia} \==, ja kirjoittajan täytyy
...
Asetukset \komento{lefthyphenmin}\komentoj{~N} ja
\komento{righthyphenmin}\komentoj{~N} vaikuttavat tavutukseen sanan
