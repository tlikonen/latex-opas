...
\koodieng{article}\-/luokkaa, joka on yleiskäyttöinen luokka
...
dokumentit tehdään luokkien \koodieng{article}, \koodieng{report} tai
\koodieng{book} avulla. Ne ovat keskenään hyvin samanlaisia, mutta
niiden oletusasetukset poikkeavat toisistaan. Karkeasti jaoteltuna
\koodieng{article}\-/luokka on tarkoitettu lyhyehköille artikkeleille ja
yleiseksi perustaksi monenlaisille dokumenteille. Sen sijaan
\koodieng{report} ja \koodieng{book} on tarkoitettu laajoihin
dokumentteihin, ja niissä on kirja\-typo\-grafian piirteitä.

Suurin edellä mainittujen perusluokkien ero on otsikoinnissa ja
dokumentin jäsentämisessä: \koodieng{report} ja \koodieng{book}
sisältävät suuret pääluvut (\koodieng{\keno chapter}) eli otsikot, jotka
alkavat tyhjältä sivulta; \koodieng{article} ei sisällä samanlaisia
päälukuja vaan ainoastaan tavalliset leipätekstin mukana kulkevat
väliotsikot (\koodieng{\keno section}, \koodieng{\keno subsection}
jne.). Otsikointia ja tekstin jäsentämistä käsitellään tarkemmin luvussa
\ref{luku:otsikot}.

Toinen ero perusluokkien välillä on se, että vain
\koodieng{book}\-/luokka sisältää komennot \koodieng{\keno frontmatter},
\koodieng{\keno mainmatter} ja \koodieng{\keno backmatter}, joita voi
...
valittaessa luokkien \koodieng{article}, \koodieng{report} ja
\koodieng{book} välillä. Dokumenttiluokkien asetuksia käsitellään
seuraavassa alaluvussa.

Muita%
\koodimargin{letter} perusdokumenttiluokkia ovat \koodieng{letter} ja
\koodieng{slides}. Nimensä mukaisesti \koodieng{letter} on kirjeiden
...
\koodieng{letter}\-/luokkaa käsitellään tarkemmin luvussa
\ref{luku:kirjeet}.

Esitys\-grafiikkaa%
\koodimargin{slides} eli dia\-esityksiä voi tehdä
\koodieng{slides}\-/luokan avulla. Tähän tarkoitukseen on kuitenkin
olemassa paljon monipuolisempi luokka \koodieng{beamer}, joten
\koodieng{slides}\-/luokan käyttö ei ole kovin mielekästä.
Dia\-esi\-tys\-ten ja \koodieng{beamer}\-/luokan perus\-asioita
...
valitsimet. Paperikoko valitaan komennoilla \koodi{a4\-paper} (210 × 297
mm), \koodi{a5\-paper} (148 × 210 mm), \koodi{b5\-paper} (176 × 250 mm),
\koodieng{executivepaper} (7,25 × 10,5 tuumaa), \koodieng{legalpaper}
(8,5 × 14 tuumaa) tai \koodieng{letterpaper} (8,5 × 11 tuumaa). Latexin
oletuksena on \koodieng{letterpaper}, mutta oletusta voi olla muutettu
...
\leijutlk{
  \begin{tabular}{llll}
    \toprule
    \koodi{a4paper} & \koodi{landscape}
    & \koodi{onecolumn} & \koodi{10pt} \\
    \koodi{a5paper} & \koodi{final}
    & \koodi{twocolumn} & \koodi{11pt} \\
    \koodi{b5paper} & \koodi{draft}
    & \koodi{openany} & \koodi{12pt} \\
    \koodi{executivepaper} & \koodi{oneside}
    & \koodi{openright} & \koodi{titlepage} \\
    \koodi{legalpaper} & \koodi{twoside}
    & \koodi{fleqn} & \koodi{notitlepage} \\
    \koodi{letterpaper} & \koodi{openbib}
    & \koodi{leqno} & \koodi{clock} \\
    \bottomrule
  \end{tabular}
}{
  \caption{Perusdokumenttiluokkien asetusten valitsimet}
