...
% Tässä voisi käsitellä komennot \newgeometry ja \restoregeometry
...
etäisyys sivun tekstipalstasta. Alatunnisteen etäisyys säädetään
valitsimella \koodi{foot\-skip}. Taulukkoon
...
\leijutlk{
  \begin{tabular}{ll}
    ...
    \koodi{footskip} & alatunnisteen etäisyys tekstipalstasta \\
    \bottomrule
  \end{tabular}
}{
...
perusteella, ja halutty tyyli asetetaan voimaan komennolla \koodi{\keno
  page\-style}:
...
ylätunnisteeseen sen, mitä \koodi{\keno left\-mark} sattuu tulostamaan.
Vastaavasti alaluvun otsikkokomento (esim. \koodi{\keno section})
määrittelee uudelleen komennon \koodi{\keno right\-mark}, niin että se
sisältää alaluvun nimen. Tämän komennon tulostama teksti ladotaan
aukeaman oikeanpuoleisille sivuille.
