...
mittayksikkö, jotka on koottu taulukkoon \ref{tlk:mittayksikot}
(s.~\pageref{tlk:mittayksikot}). Sivun asetusten suunnittelussa voi olla
avuksi valitsin%
...
Sivun tekstialueen ja marginaalit voi määrittää myös suhteellisesti.
Voisi esimerkiksi määrittää, että leveyssuunnassa tekstialue täyttää
0,7\=/kertaisesti (70\,\%) paperin leveyden ja loput jää marginaaleille.
Marginaalien keskinäiset suhteetkin voi ilmaista suhdelukuna:
esimerkiksi vasemman ja oikean marginaalin suhde voisi olla 2:3.
Suhteellisessa tavassa ei tarvitse ottaa kantaa paperin kokoon eikä
muihinkaan varsinaisiin mittoihin, vaan samat tekstialueen ja
marginaalien suhteet säilyvät, vaikka paperikokoa muuttaisikin.
Suhteellisia mittoja koskevia valitsimia on koottu taulukkoon
\ref{tlk:sivun_marginaalit_suhd}.
...
\leijutlk{
  ...
  \caption{\paketti{geometry}\-/paketin valitsimia sivun tekstitilan ja
    ...
    ilmaistaan prosenttikertoimella, esimerkiksi \koodi{0.7}. Suhteet
    (\koodi{*marginratio}) ilmaistaan suhdelukuna, esimerkiksi
    \koodi{2:3}}
...
voidaan käyttää huomautusten kirjoittamiseen (luku
\ref{luku:marginaalihuomautukset}), mikä onkin melko yleinen käytäntö
tietokirjoissa.
...
% head, headsep
% footskip
% marginparwidth, marginparsep, reversemarginpar, nomarginpar
