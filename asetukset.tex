...
ainakin neljä eri leikkausta: tavallinen, kursiivi, lihavoitu ja
...
kirjakkeen päähän muotoiltua kirjaimen tai muun merkin kohokuviota, joka
...
groteskia%
\footnote{Tämän oppaan groteskifontti Libertinus Sans on
  mittasuhteiltaan lähellä antiikvaa -- ainoastaan pääteviivat
  puuttuvat. Tämäntyyppisiä fontteja sanotaan joskus humanistisiksi
  groteskeiksi tai pääteviivattomiksi antiikvoiksi.} ja
koodi\-esi\-mer\-keis\-sä tasalevyistä. Kirjoituskoneen kaltainen
tasalevyinen kirjainperhe on tässä tapauksessa tyypiltään antiikva eli
...
koostuvia fontteja. Ne voidaan muuttaa Post Script Type~1 \=/muotoon.
Myöhemmin mukaan ovat tulleet nykyaikaiset True Type- ja Open Type
\=/muotoiset fontit, ja niihin tämä opas keskittyy.
...
Edellisessä esimerkissä peruskirjainperheen (\koodi{\keno setmainfont})
skaalaus on 1, eli sille ei tehdä mitään, ja koko valitsimen voisi
jättää pois. Sen sijaan kahdella muulla kirjainperheellä (\koodi{\keno
...
\textenglish{series} 'sarja' ja \textenglish{shape} 'muoto'. Kummastakin
ryhmästä on valittuna aina yksi, eli samanaikaisesti voi olla voimassa
esimerkiksi \koodi{\keno bfseries} (lihavoitu) ja \koodi{\keno itshape}
(kursiivi), ja tuloksena on \textbf{\itshape lihavoitua kursiivia}.
...
leikkauksen kallistettu versio. Kallistus on voitu tehdä koneellisesti,
mutta se voi olla myös kirjainmuotoilijan piirtämä leikkaus. Kursiivissa
puolestaan kirjaimet ovat muodoltaan erilaisia, ja se hieman jäljittelee
yhtenäistä käsi\-ala\-kir\-joi\-tusta.
