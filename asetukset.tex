...
Sivun marginaaleihin vaikutetaan taulukkoon \ref{tlk:sivun_marginaalit}
kootuilla valitsimilla. Mukana ovat tärkeimmät valitsimet mutta eivät
ihan kaikki. Valitsimille annetaan arvoksi Texin mittayksikkö, jotka on
koottu taulukkoon \ref{tlk:mittayksikot}
(s.~\pageref{tlk:mittayksikot}). Sivun asetusten määrittämisessä voi
olla avuksi valitsin \koodi{show\-frame}, joka piirtää viivat
...
\leijutlk{
  \begin{tabular}{ll}
    ...
    \rivi{vmargin}{ylä- ja alamarginaali}
    \midrule
    \rivi{left}{vasen marginaali  (kaksipuolisessa sisämarginaali)}
    \rivi{inner}{''}
    \rivi{right}{oikea marginaali (kaksipuolisessa ulkomarginaali)}
    \rivi{outer}{''}
    \rivi{hmargin}{vasen ja oikea marginaali}
    \bottomrule
  \end{tabular}
}{
