...
halutaan oletuskieleksi.

\begin{koodilohkosis}
  \usepackage[english,greek,finnish]{babel}
\end{koodilohkosis}

Yksittäiset vieraskieliset sanat merkitään komennolla \koodi{\keno
  foreign\-lan\-guage}. Komennon ensimmäinen argumentti on kielen nimi
ja toinen on tällä kielellä ladottava teksti. Komennon sijasta voi
äyttää ympäristöä \koodi{other\-lan\-guage}, joka vaihtaa kieltä
ympäristön ajaksi.
...
\begin{koodilohkosis}
  % Luo komennon \texteng{…} ja ympäristön ”eng”:
  \babeltags{eng = english}
  % Luo komennon \textenglish{…} ja ympäristön ”english”:
...
% On myös mahdollista ottaa käyttöön vieraasta kielestä pelkästään
% tavutussäännöt mutta ei mitään
