...
Edellisessä esimerkissä TeX Gyre Termes, Heros ja Cursor%
\footnote{TeX Gyre \=/fonttipaketti:
  \url{https://www.ctan.org/pkg/tex-gyre}} ovat fonttien nimiä, ja
fonttien tulee olla asennettuna käyttöjärjestelmän normaalien
käytäntöjen mukaisesti tai Latex\-/jakelun käytäntöjen mukaisesti.

Kirjainperheiden käyttöön\-oton yhteydessä voi määritellä lukuisia
...
jul\-kai\-su\-oh\-jel\-miin vakiintunutta uudempaa pica\-/pistettä, joka
on hieman edellistä pidempi: noin \num{0,3528} millimetriä. Latexissa
sen lyhenne on~\emph{bp}. Ero näiden kahden pistemitan välillä on hyvin
pieni, tavallisilla fonttiko'oilla käytännössä merkityksetön.
...
\begin{esimerkki}
\begin{koodilohko}
  \fontsize{10bp}{14bp}\selectfont Tässä on pienehkö leipätekstin
  fonttikoko ja suhteellisen suuri rivikorkeus. Pitkät rivit vaativat
  suuremman rivikorkeuden kuin lyhyet rivit.

  \fontsize{16bp}{18bp}\selectfont Tässä on melko suuri fontti ja
