...
BoldSlantedFont=*-bold, BoldSlantedFeatures={FakeSlant=.2},
Extension=.otf]

% Poistetaan tasalevyiseltä fontilta oletusasetukset. Se muun muassa
% kytkee tavutuksen päälle, koska oletus on HyphenChar=None.
