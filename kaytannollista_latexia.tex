...
\hypersetup{ hidelinks, bookmarksopen, bookmarksnumbered, pdfinfo={
    Author={Teemu Likonen}, Title={Käytännöllistä Latexia},
...
\newcommand{\komentox}[2][]{\koodi{\keno #2}\koodi{#1}}
...

{
  ...
  Versio \input{versio.tex}\ignorespaces
