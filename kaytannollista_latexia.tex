...
\definecolor{luokka}{rgb}{.5,.5,0}
\definecolor{komento}{rgb}{0,0,.5}
\definecolor{ymparisto}{rgb}{0,.5,0}
\definecolor{mitta}{rgb}{.5,0,0}
\definecolor{laskuri}{rgb}{.5,0,.5}
\definecolor{paketti}{rgb}{0,.5,.5}
...
\newcommand{\luokkax}[1]{\textcolor{luokka}{\koodi{#1}}}
