...
\makeindex[name=dokumenttiluokat, title={Dokumenttiluokat}, columns=1,
columnsep=1em]
...
\newcommand{\koodil}[1]{\enquote{\koodi{#1}}}

\newcommand{\luokkax}[1]{\textcolor{luokka}{\textsf{#1}}}
\newcommand{\luokkai}[1]{\index[dokumenttiluokat]{\luokkax{#1}}}
...
\newcommand{\komentojatko}[1]{\textcolor{komento}{\koodi{#1}}}
