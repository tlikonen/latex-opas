...
\pageref{luku:kirjallisuutta} on siitä esimerkki lähdemerkinnöistä.
...
\begin{koodilohko}
  ...
  alkaa yhdellä sisentämättömällä rivillä, ja kappaleen muut rivit on
  sisennetty 2\,cm.
\end{koodilohko}
\begin{tulos}
  \hangpara{2cm}{1}Tässä tekstikappaleessa on riippuva sisennys. Kappale
...
komennon \koodi{\keno hang\-para}, jonka käyttöä esimerkki
...
monta riviä jätetään sisentämättä. Jos toinen argumentti on negatiivinen
...
luvussa \ref{luku:luetelmat}, mutta esimerkissä
...
% koko kappaleen vasen ja oikea sisennys
