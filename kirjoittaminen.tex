...
Ympäristölle annetaan samat argumentit kuin komennollekin.
...
\begin{koodilohkosis}
  \begin{lohkolainaus}
    ...
    kirjainleikkaus ja riviväli ovat hieman pienempiä kuin
    leipätekstissä.
  \end{lohkolainaus}
\end{koodilohkosis}
...
11 oleva \koodi{\keno item}\-/ komento pakollinen, koska se aloittaa
