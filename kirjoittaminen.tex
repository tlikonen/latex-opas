...
mukaan aakkostetun luettelon seuraamista.

Pienversaali toimii välillä typografisesti parempana vaihtoehtona
versaalikirjaimille. Silloin sen tarkoituksena ei ole tekstin
korostamiseen vaan päinvastoin häiritsevän korostuksen välttäminen.
Esimerkiksi versaalikirjaimiset lyhenteet (SPR, HTML) voivat paljon
käytettynä erottua leipätekstistä häiritsevän paljon, eikä tekstipalsta
näytä tasaiselta. Pienversaalina ne sulautuvat muuhun tekstiin paremmin
(\textsc{spr}, \textsc{html}).

Typografisesta estetiikasta juontuu sekin, että pienversaali on sopiva
pari gemenanumeroiden kanssa erilaisiin koodeihin ja teknisiin
ilmauksiin, jotka koostuvat kirjaimista ja numeroista (esim.
{\scshape\gemenanum iso-8859\=/1}). Versaalikirjaimia ja gemenanumeroita
ei sovi käyttää yhdessä, koska merkkien koko\-ero on häiritsevän suuri
({\gemenanum ISO-8859\=/1}). Gemenanumerot ovat nekin fontin ominaisuus,
ja niiden käyttöönottoa ja muita numeroihin liittyviä asetuksia
käsitellään luvussa \ref{luku:fontit_numerot}.
