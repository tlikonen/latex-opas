...
Makropaketti \paketti{natbib} laajentaa Latexin lähdeviittausten
...
ohjekirjan avulla.\avctan{natbib} On muun muassa mahdollista tehdä
lähdeteoksista tietokanta Bibtex\-/järjestelmän avulla. Jos kuitenkin
siihen suuntaan haluaa edetä, ei kannata käyttää
\paketti{natbib}\-/pakettia eikä Bibtexiä vaan monipuolisempaa pakettia
\paketti{bib\-latex}, jota käsitellään seuraavassa alaluvussa.

\subsection{Tutkijan keinovalikoima (biblatex)}
\label{luku:biblatex}
