...
erityyppistä teostietuetta: \koodi{book}, \koodi{incollection},
\koodi{article} ja \koodi{online}. Erityyppisillä teostietueilla on
...
\koodi{author}, \koodi{title} ja \koodi{date} erotetaan toisistaan
pilkulla.
...
\kulmaurl{http://www.bibtex.org/Format/}. Teostyyppien ja kenttien
merkitystä ja käyttöä neuvotaan \paketti{bib\-latex}\-/paketin
ohjekirjassa.
