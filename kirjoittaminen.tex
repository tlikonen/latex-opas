...
Teostyyppi%
\koodimargin{in\-collection} \koodi{incollection} tarkoittaa esimerkiksi
...
merkitystä ja käyttöä neuvotaan \paketti{biblatex}\-/paketin
ohjekirjassa.
...
\ref{luku:lainausmerkit}). Ilman sitä \paketti{biblatex} ei saa eri
...
suomenkielisissä teksteissä, mutta monia muitakin tyylejä on olemassa ja
saatavilla.
