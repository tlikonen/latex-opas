...
Sopiva mittayksikkö tähän tarkoitukseen on ''em'', koska se viittaa
suoraan nykyisen fontin kokoon (katso mitoista lisätietoa luvusta
\ref{luku:mitat}).
...
että sen jälkeen alkaa uusi kappale.
...
muun vastaavan elementin jälkeen. Käytäntöön on hieman poikkeuksia
suomenkielisessäkin typografiassa, mutta varsinkin eri kielten välillä
käytäntö voi vaihdella enemmänkin.

Latex estää sisennyksen automaattisesti otsikoiden jälkeen mutta latoo
sen kuitenkin kaikkien muiden elementtien ja pystysuuntaisen välin
jälkeen. Jos sisennys halutaan estää, pitäisi kyseiset kappaleet
...
%   }
% \item \makebox[5em][l]{Tässä}on tekstikappale. Tässä on tekstikappale.
%   Tässä on tekstikappale. Tässä on tekstikappale. Tässä on
%   tekstikappale. Tässä on tekstikappale. Tässä on tekstikappale. Tässä
%   on tekstikappale.

%   Tässä on tekstikappale. Tässä on tekstikappale. Tässä on
%   tekstikappale. Tässä on tekstikappale. Tässä on tekstikappale. Tässä
%   on tekstikappale. Tässä on tekstikappale. Tässä on tekstikappale.
% \end{list}
