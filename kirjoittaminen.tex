...
Makropaketti otetaan käyttöön esimerkin \ref{esim:biblatex-käyttöönotto}
rivien avulla. Mukana on myös paketti \paketti{polyglossia} ja
\paketti{cs\-quotes}. Jälkimmäinen sisältää lainausmerkkien käyttöön
liittyvää logiikkaa (luku \ref{luku:lainausmerkit}). Ilman sitä
\paketti{bib\-latex} ei saa eri kielten erilaisia lainausmerkkejä
oikein.
...
ajatusviivan, jos tekijä on sama kuin luettelon edellisessäkin
teoksessa. Mikäli tätä ei halua, täytyy valitsimen arvoksi kirjoittaa
\koodi{false}.
