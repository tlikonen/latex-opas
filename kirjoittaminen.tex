...
rivejä. Leskirivi (engl. \emph{\englanti{widow}}) on tekstikappaleen
viimeinen rivi, joka on yksinään sivun tai palstan yläreunassa. Orporivi
(engl. \emph{\englanti{orphan}}) puolestaan on tekstikappaleen
ensimmäinen rivi, joka on yksin sivun tai palstan alareunassa. Molemmat
voivat näyttää ikävältä, mutta yleensä orporivejä ei pidetä kovin
vakavana virheenä; leskien välttämisessä ollaan enemmän tosissaan.
...
haitallisuusarvoa tai sakko\-arvoa (engl. \emph{\englanti{penalty}}), ja
jos lesket ja orvot halutaan estää, määritellään niiden haitallisuusarvo
