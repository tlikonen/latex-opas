...
Tarvitaan myös \paketti{biblatex}\-/paketin mukana tulevaa komentoa
\koodi{bib\-er}, joka käsittelee teostietokantaan liittyviä tiedostoja.
...
''Teoksessa: \textit{Hieno artikkelikokoelma.} Toim. Toimittaja,
Teppo''. Ensin siis mainitaan julkaisun nimi ja sen jälkeen toimittajien
...
\begin{tulossis}
  -- -- Teoksessa: Toimittaja, Teppo (toim.). \textit{Hieno
    artikkelikokoelma}. -- --
\end{tulossis}
