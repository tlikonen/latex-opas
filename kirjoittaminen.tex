...
\section{Vasen ja oikea sisennys sekä lohkolainaus}

% Jotain yleiskuvaa, jossa mainitaan myös lohkolainaus.
...
% Tällaista kappaleen sisennystä voidaan tarvita esimerkiksi
% lohkolainauksissa.
