...
\pakettictan{libertinus}\yipilkku%
\footnote{Libertinus Serif \=/perheen \textsc{pienversaali} ei
  välttämättä toimi \paketti{polyglossia}\-/ kielipaketin kanssa, ellei
  kirjoita dokumentin tekstiosan alkuun komentoa \komento{rmfamily}.}:
