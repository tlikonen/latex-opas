...
\koodi{schoolhyphens}. Lisätietoa suomen tavutuksen erityispiirteistä on
luvussa \ref{luku/suomi-tavutus}.
...
lataamalla paketin \paketti{hyphsubst} ja kertomalla sen asetuksissa,
että tavutuksen kieli \koodi{finnish} korvataan kielellä
\koodi{school\-finnish}. Paketti \paketti{hyphsubst} täytyy ladata
\paketti{babel}\-/ paketin jälkeen, seuraavan esimerkin mukaisesti.
