...
\noindent
Asetus \koodi{babelshorthands} lisää erikoismerkkivalikoimaan alla
olevat tavutukseen vaikuttavat merkit. Taulukossa
\ref{tlk/polyglossia-tavutus} on esimerkkejä tavutusvihjeiden,
yhdysmerkin ja ajatusviivan sekä \paketti{polyglossia}\-/ paketin
...
\koodi{schoolhyphens}. Se kytkee päälle yksinkertaisen
tavutussäännöstön, jossa sanan katkaiseminen sallitaan kaikista
mahdollisista suomen kielen tavutuskohdista. Lisätietoa suomen
tavutuksen erityispiirteistä on luvussa \ref{luku/suomi-tavutus}.
...
\subsection{Suomen kielen tavutus KESKEN}
