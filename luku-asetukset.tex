...
Libertinus\-/ kirjainperheet\footnote{Libertinus Serif \=/perheen
  \textsc{pienversaali} ei välttämättä toimi \paketti{polyglossia}\-/
  kielipaketin kanssa, ellei kirjoita dokumentin tekstiosan alkuun
  komentoa \komento{rmfamily}.} saa käyttöön lataamalla paketin
