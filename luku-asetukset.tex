...
\subsection{Polyglossia ja tavutus KESKEN}

Kielipaketti \pakettictan{polyglossia} (luku \ref{luku/polyglossia})
...
\koodi{babelshorthands}, joka tuo mukaan muutaman tavutukseen
...
tavutukseen vaikuttavat merkit.
...
\leijutlk{
  ...
  \caption{Tavutusvihjeen, yhdysmerkin ja ajatusviivan sekä
    \paketti{polyglossia}\-/ paketin erikoismerkkien
    (\koodi{babelshorthands}) vaikutus tavutukseen}
  \label{tlk/polyglossia-tavutus}
}

\noindent
Taulukossa \ref{tlk/polyglossia-tavutus} on esimerkkejä
tavutusvihjeiden, yhdysmerkin ja ajatusviivan sekä
\paketti{polyglossia}\-/ paketin erikoismerkkien vaikutuksesta.

% käsitellään schoolhyphens
...
Kielipaketti \pakettictan{babel}\yipilkku\footnote{Katso myös
  \paketti{babel}\-/ paketin mukana toimitettavat kielikohtaiset
  dokumentit, esimerkiksi tiedosto \koodi{finnish.pdf}.} (luku
...
\leijutlk{
  ...
  \caption{Tavutusvihjeen, yhdysmerkin ja ajatusviivan sekä
    \paketti{babel}\-/ paketin suomen kieliasetusten ja erikoismerkkien
...
ajatusviivoja sekä \paketti{babel}\-/ paketin erikoismerkkejä.

\subsection{Viivojen erikoispaketti extdash KESKEN}

Paketti \pakettictan{extdash} tuo uusia komentoja viivavälimerkeille ja
...
% Suomen kielelle on olemassa Latexissa kaksi erilaista tavutussääntöä.
% Oletuksena toimivat säännöt kuvaavat tavujen rakenteen mutta pyrkivät
% huomioimaan myös typografisia suosituksia. Sanaa ei esimerkiksi
% katkaista vokaalien välistä, koska se ei ole suositeltavaa. Myös jotkin
% yleiset vierasperäisten sanojen konsonanttiyhdistelmät pidetään yhdessä,
% vaikka ne suomen tavurakenteen mukaan kuuluisivat joskus eri tavuihin.
...
% huomioi typografisia suosituksia mitenkään. Tämä vaihtoehtoinen
% tavutustapa täytyy kytkeä erikseen päälle kielipaketin asetuksista.

% Sitova yhdysmerkki on tarpeellinen suomen kielessä, kun yhdysmerkkiä
% ennen on sanaväli. Esimerkiksi ilmauksessa \emph{matkasuunnitelma ja
%   \mbox{-aika}} ei riviä saa katkaista sanassa \emph{\mbox{-aika}}
% olevan yhdysmerkin jälkeen. Täytyy siis käyttää sitovaa yhdysmerkkiä eli
% merkkiä, joka sitoo yhdysmerkin kiinni seuraavaan
% sanaan.\footnote{Latexin peruskeinoilla sana täytyisi laittaa
%   näkymättömään laatikkoon, joka pitää merkit yhdessä:
%   \komento{mbox}\komentoarg{-aika}.}
