...
\leijutlk{
  ...
  \begin{tabular}{llll}
    ...
    \rivi {swshape} {textsw} {\swshape leikkaus}
    {koristeellinen, swash}
...
kirjainmuotoilijan piirtämä leikkaus ja erillinen fonttitiedosto,
jolloin kallistettu leikkaus täytynee erikseen määrittää osaksi
kirjainperhettä \koodi{Slanted\-Font}\-/ asetuksella (esimerkki
\ref{esim/fontit-leik-omin}). Kallistuksen voi tehdä myös
keinotekoisesti Latexissa. Katso lisätietoa luvusta
\ref{luku/fontit-venytys}.

Jotkut harvat \englanti{Open Type} \=/fontit sisältävät erillisen
koristeellisen tyylin (\komento{swshape}), joka voi sisältyä esimerkiksi
kursiivileikkaukseen. Sellaisen saa määritettyä osaksi kirjainperhettä
...
\setmainfont{Garamond Premier Pro}[
  SwashFont={GaramondPremrPro-It}, SwashFeatures={Style=Swash}]
\end{koodilohkosis}
...
Kääntäjät Lualatex ja Xelatex -- tai oikeastaan niiden taustalla
toimivat Luatex ja Xetex -- käsittelevät fontteja sisäisesti eri
tavalla. Ne esimerkiksi hyväksyvät kirjainperheiden tai \=/leikkausten
nimet hieman toisistaan poikkeavalla tavalla, ja kääntäjää vaihtaessa
saattaa joskus huomata, ettei jotakin kirjainperhettä tai yksittäistä
leikkausta enää löydykään.
...
käyttämällä fontin määrittelyssä valitsinta \koodi{Renderer} seuraavan
esimerkin tavoin:
...
perusfontille kaltevan leikkauksen. Tämän jälkeen komennot
\komento{slshape} ja \komento{textsl} valitsevat \textsl{kaltevan}
leikkauksen, joka on siis eri asia kuin \textit{kursiivi}
(\komento{itshape}, \komento{textit}).
