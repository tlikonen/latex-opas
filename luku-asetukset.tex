...
\leijutlk{
  ...
  \caption{Vapaita fontteja, jotka toimitetaan Tex Live \=/jakelun
    mukana. Tyylit viittaavat kirjainmuotoon tai historialliseen
    kirjaintyyliin}
...
\ref{tlk/vapaita-fontteja} on koottu Tex Live \=/jakelun mukana tulevia
vapaita kirjainperheitä.
...
\leijutlk{
  \begin{tabular}{r@{\quad$\longleftrightarrow$\quad}l}
    ...
    \midrule
    Libertinus Serif & Libertinus Math \\
    ...
    DejaVu Serif & TeX Gyre Dejavu Math \\
    Garamond Libre & Garamond Math \\
    Latin Modern Roman & Latin Modern Math \\
    \bottomrule
  \end{tabular}
}{
  \caption{Yhteensopivia leipätekstin ja matematiikkatilan fontteja}
  \label{tlk/matematiikka-fontteja}
}

\noindent
Taulukkoon \ref{tlk/matematiikka-fontteja} on koottu \englanti{Open
  Type} \=/kirjainperheitä, joille on saatavilla keskenään yhteensopiva
leipätekstin kirjainperhe ja matematiikkatilan fontti. Kaikki fontit
ovat vapaita ja toimitetaan Tex Live \=/jakelun mukana.
