...
\item [\textquotedbl=] Sama kuin edellinen (\koodi{\textquotedbl-}).%
  \footnote{\paketti{polyglossia}\-/ paketin ohjekirjan mukaan
    \textquotedbl- ja \textquotedbl= toimivat tavutuksen sallimisen
    kannalta eri tavoin. Mitään eroa ei kuitenkaan todellisuudessa näy.}
