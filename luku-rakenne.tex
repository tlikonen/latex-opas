...
leipätekstissä värejä kannattaa käyttää hillitymmin, sillä värikäs
tekstipalsta näyttää rauhattomalta. Katse voi hakeutua värillisiin osiin
liian helposti, mikä hidastaa lukemista. Värien käsittelyn tekniikkaa
käsitellään luvussa \ref{luku/värit}.
...
\leijutlk{
  ...
  \caption{Esimerkkejä luetelmiin sopivista merkeistä.
    Matematiikkatilassa on saatavilla muitakin symboleja. Katso
    esimerkiksi taulukko \ref{tlk/matem-sekalaisia}
    (s.~\pageref{tlk/matem-sekalaisia})}
...
Taulukkoon \ref{tlk/luetelmamerkkejä} on koottu esimerkkejä luetelmiin
sopivista merkeistä.
