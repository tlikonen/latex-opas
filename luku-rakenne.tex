...
\usepackage[all]{nowidow}  % edelliset tiiviimmin
\end{koodilohkosis}
...
Nämä tähtikomennot latovat otsikon, jolla ei ole numerointia ja jota ei
lisätä sisällysluetteloon.

Pelkän otsikon numeroinnin poistamiseen ei ehkä kannata käyttää edellä
mainittuja tähtikomentoja, koska yleensä otsikko kuitenkin halutaan
sisällysluetteloon. Otsikoiden numeroinnin saa pois asettamalla laskurin
\laskuri{secnumdepth} sopivasti. Katso ohjeet luvusta
\ref{luku/otsikot-numerointi}. Jos kuitenkin haluaa käyttää tähdellistä
otsikkokomentoa ja haluaa otsikon myös sisällysluetteloon, täytyy se
...
\komento{section}\-/ komennolla syntyviä otsikoita. Komento
\komento{phantomsection} kuuluu \paketti{hyperref}\-/ pakettiin, ja se
lisää pdf\-/ tiedostoon näkymättömän ankkurin tähän kohtaan
dokumentissa. Sitä tarvitaan, jotta sisällysluettelon merkintä viittaisi
oikealle sivulle ja toimisi myös linkkinä, joka tuo juuri tähän kohtaan.

Omia otsikoita voi myös lisätä pelkästään pdf\-/ tiedoston sisäiseen
sisällysluetteloon. Se tehdään komennolla \komento{pdfbookmark}, joka ei
siis lado varsinaiseen dokumenttiin mitään. Komennon käyttöä neuvotaan
luvussa \ref{luku/pdf-asetukset}.
...
Laskuri \laskuri{secnumdepth} on tarkoitettu kirjoittajan asetettavaksi,
ja sillä määritetään, mihin otsikkotasoon saakka otsikot numeroidaan.
Tasonumerot ovat taulukossa \ref{tlk/otsikkotasot}
(s.~\pageref{tlk/otsikkotasot}). Seuraavista esimerkeistä ensimmäinen
määrittelee, että vain tasoon~1 (\komento{section}) saakka lukujen
otsikot numeroidaan eli alemmantasoiset otsikot (\komento{subsection}
ym.) eivät saa numeroa. Toinen esimerkkirivi poistaa numeroinnin
kokonaan.

\komentoi{setcounter}
\laskurii{secnumdepth}
\begin{koodilohkosis}
\setcounter{secnumdepth}{1}  % \section-taso ja ylemmät numeroidaan
\setcounter{secnumdepth}{-2} % numerointi pois kaikkialta
\end{koodilohkosis}
...
olevalla yläindeksinumerolla, \=/kirjaimella tai \=/symbolilla.
...
alaviitteiden avulla.\footcites[162]{kt_oik}[127--128]{typokk} Katso
myös ylä- ja alaindeksejä käsittelevä luku \ref{luku/ylä-alaindeksit}.
Siellä mainitun \paketti{realscripts}\-/ paketin lataaminen on
suositeltavaa, kun käyttää alaviitteitä.
...
Silti voi olla helpompaa käyttää erityisiä komentoja joidenkin symbolien
kirjoittamiseen. Matematiikkatilan erikoismerkkejä on koottu oheisiin
taulukoihin (\ref{tlk/matem-kreikk}--). Lisää symboleja on paketeissa
