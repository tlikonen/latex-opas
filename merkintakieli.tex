...
Taulukon tarkekomennoissa on käytetty yleensä a\=/kirjainta esimerkkinä,
mutta muutkin kirjaimet toimivat. Kaikki merkit voi kirjoittaa
...
\leijutlk{
  \begin{tabular}[t]{lll}
    ...
    \rivi{`a}{\`a}{gravis}
    \rivi{'a}{\'a}{akuutti}
    \rivi{\textasciicircum a}{\^a}{sirkumfleksi}
    \rivi{\~{}a}{\~a}{tilde}
    ...
    %\rivi{b\{a\}}{\b{a}}{''underbar''}
    \rivi{c\{c\}}{\c{c}}{sedilji}
  ...
  \begin{tabular}[t]{lll}
    ...
    \rivi{DJ}{\DJ}{D ja poikkiviiva}
    \rivi{dj}{\dj}{d ja poikkiviiva}
    \rivi{L}{\L}{L ja poikkiviiva}
    \rivi{l}{\l}{l ja poikkiviiva}
    \rivi{O}{\O}{O ja poikkiviiva}
    \rivi{o}{\o}{o ja poikkiviiva}
    \rivi{NG}{\NG}{iso äng}
    \rivi{ng}{\ng}{pieni äng}
