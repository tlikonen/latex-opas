...
Tasalevyiselle fontille saa tavutuksen päälle fontin asetuksella
\koodi{Hyphen\-Char=\{\=/\}}. Tällä asetuksella määritellään
tavutuksessa käytettävä merkki, mutta se toimii vain
Xelatex\-/kääntäjällä. Lualatex\-/kääntäjällä ei tavutusmerkkiä voi
valita vaan tämä asetus ainoastaan kytkee tavutuksen päälle tai pois.
