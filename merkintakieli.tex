...
nimen jälkeen aaltosulkeet (\komentox{komento}\komentoarg{}) tai
kenoviiva ja sanaväli (\komentox{komento}\komentoj{\keno~}). Komennon
nimen ja argumenttien välissä voi olla sanavälejä, ja ne kaikki syödään
pois. Komennon ja sen argumentit voi siis kirjoittaa vaikka seuraavalla
tavalla:
...
Komentojen toinen pakollinen argumentti \koodil{määritelmä} sisältää
...
Komentojen ensimmäinen valinnainen argumentti \koodil{n} on luku, joka
...
Toinen valinnainen argumentti \koodil{oletus} -- jos se on mukana --
...
komennoillekin. Ensimmäinen valinnainen argumentti \koodil{n} on luku
...
Jos toinen valinnainen argumentti \koodil{oletus} on mukana, se
...
Käytännöllisyyssyistä äärettömästi venyvä pituus \koodil{0mm plus 1fill}
