...
\leijutlk{
  ...
  \begin{tabular}{lll}
    \toprule
    \ots{Komento} & \ots{\englanti{Open Type}} & \ots{Mekaaninen} \\
    \midrule
    \komento{textsuperscript} & x\textsuperscript{ab36}
                                               & x\textsuperscript*{ab36} \\
    \komento{textsubscript} & H\textsubscript{2}SO\textsubscript{4}
    & H\textsubscript*{2}SO\textsubscript*{4} \\
    \bottomrule
  \end{tabular}
}{
  \caption{Ylä- ja alaindeksien vertailua. Open Type \=/fonttien oikeat
    indeksit saadaan \paketti{realscripts}\-/ paketin avulla. Mekaaninen
    toteutus perustuu fontin pienentämiseen}
  \label{tlk:indeksien_vertailu}
}
