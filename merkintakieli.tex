...
kursivointikomennon \komento{itshape} vai\-ku\-tus\-aluetta.
...
gra\-vis\-ak\-sent\-ti (\`{}) tehdään komennolla
\komento{`}\koodi{\{\}}. Lainausmerkkien merkintätapoja ja komentoja on
...
(\komento{texttt}\koodi{\{--\}}), joka oletuksena kytkee pois Latexin
...
\providecommand{\rivi}{}
\renewcommand{\rivi}[4][]{{\erikoisfontti #3} & \komento{#2}\koodi{#1} & #4}
...
Komento \komento{-} on tavutusvihje, joka neuvoo
tavu\-tus\-algo\-rit\-mia katkaisemaan sanan tästä kohdasta. Samalla se
voi estää sanan katkaisemisen muista kohdista.
...
komennolla \komento{textsc}. Silti tätä komentoa ei ehkä kannata käyttää
suoraan dokumentissa. Jos nimittäin kirjoittaa dokumentin täyteen
\komento{textsc}\-/komentoja, voi myöhemmin olla työlästä muuttaa
...
mukaan eikä suomen. Pitäisi siis liittää \komento{textsc}\-/ komentojen
ympärille vielä \komento{textenglish}\-/komento.%
\footnote{Komento \komento{textenglish} on \paketti{polyglossia}\-/
  paketin ominaisuus.} Lähdedokumentin kirjoittaminen on ikävää ja
ulko\-asu sekava, jos Unicode\-/tunnusten kohdalla on aina \koodi{\keno
  textenglish\{\keno text\-sc\{\ldots\}\}}.
...
\komentox{uctunnus}, jota käytetään aina tunnusten ilmaisemiseen
...
asetetaan \komentox{komento} tiettyyn alkuperäismääritelmään.
...
teks\-ti\-alueen leveys nykyisellä sivulla. Komentomaisesta
...
mitat \mittax{leveys}, \mittax{korkeus} ja \mittax{syvyys}, joihin
sitten tallennetaan merkkien mitat.
...
komennolla \komento{vfill}, joka tekee saman asian kuin
\komento{vspace}\koodi{\{0mm plus 1fill\}}.
...
\koodi{mp\-foot\-note}. Numeroidut luetelmat (luku \ref{luku:luetelmat})
...
\leijutlk{
  \begin{tabular}{ll}
    ...
    \midrule
    \komento{arabic}\koodi{\{\ldots\}} & arabialainen luku: 1, 2, 3\ldots \\
    \komento{roman}\koodi{\{\ldots\}} & roomalainen luku: i, ii, iii\ldots \\
    \komento{Roman}\koodi{\{\ldots\}} & roomalainen luku: I, II, III\ldots \\
    \komento{alph}\koodi{\{\ldots\}} & kirjain: a, b, c\ldots\ (vain 1--26) \\
    \komento{Alph}\koodi{\{\ldots\}} & kirjain: A, B, C\ldots\ (vain 1--26) \\
    \komento{fnsymbol}\koodi{\{\ldots\}} & symboli:
                                           \textasteriskcentered
                                           \textdagger
...
kuin komento \komento{arabic}\koodi{\{page\}}. Aina nämä eivät
...
taulukon numeron. Viimeisin taulukko oli numeroltaan \thetable{} eli
