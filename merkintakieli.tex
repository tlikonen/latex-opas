...
\leijutlk{
  ...
  \begin{tabular}{cll}
    ...
    \rivi[\komento{\^{}}\textcolor{komento}{\koodi{\{\}}}]
...
Komentojen ensimmäinen valinnainen argumentti ''\koodi{n}'' on luku,
joka kertoo, kuinka monta argumenttia määriteltävä komento käsittelee.
...
\ref{esim:aaltosulkeet_rajaaminen} alussa asetetaan \komentox{komento}
