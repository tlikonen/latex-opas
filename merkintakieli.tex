...
ei kaikissa fonteissa edes ole, ja puuttuvan merkin tilalla saattaa
näkyä esimerkiksi suorakulmio \puuttuvamerkki. Se kuitenkin riippuu
fontista.
...
ladontajärjestelmän logojen kirjoittamiseen: \koodi{\keno TeX},
\koodi{\keno LaTeX} ja \koodi{\keno LaTeXe}.
...
\leijutlk{
  \begin{tabular}{cll}
    ...
    \rivi{\textbraceleft}{textbraceleft}{vasen aaltosulje}
    \rivi{\textbraceright}{textbraceright}{oikea aaltosulje}
...
varten on \koodieng{page}\-/laskuri ja matemaattisten kaavojen
numerointiin \koodieng{equation}\-/laskuri. Leijuvista kuvista ja
taulukoista (luku \ref{luku:leijuosat}) pidetään kirjaa laskureissa
\koodieng{figure} ja \koodieng{table}, ja alaviitteiden (luku
\ref{luku:alaviitteet} ) numerointi on laskureissa \koodieng{footnote} ja
\koodieng{mpfootnote}. Numeroidut luetelmat (luku \ref{luku:luetelmat})
...
asian kuin komento \koodieng{\keno arabic\{page\}}. Aina nämä eivät
...
komentoa \koodieng{\keno value}. Seuraava esimerkki luo laskurin nimeltä
...
kun sivu vaihtuu eli laskurin \koodieng{page} arvo kasvaa.
...
Makropaketti \paketti{chngcntr}\avusepkg{chngcntr} helpottaa
...
tallentamiseen on olemassa makropaketti \paketti{tot\-pages}, joka lisää
viimeiselle sivulle automaattisesti ristiviitteen nimeltä
\koodi{Tot\-Pages}. Sivumäärän ja viimeisen sivun numeron voi tulostaa
komennoilla \koodi{\keno ref} ja \koodi{\keno page\-ref}. Esimerkki
...
\paketti{tot\-count}\-/pakettia.\avusepkg{totcount} Paketti tarjoaa
