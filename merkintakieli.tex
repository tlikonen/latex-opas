...
lähdedokumenttiin kaksi kenoviivaa (\koodi{\keno\keno}). Tätä komentoa
...
kytketään päälle komennolla \koodi{\keno obey\-cr}; \koodimargin{\keno
  obeycr} normaaliin tilaan palataan taas komennolla \koodi{\keno
  re\-store\-cr}. \koodimargin{\keno re\-store\-cr} Näistä komennoista
voi olla hyötyä väliaikaisesti ja erityistilanteissa, mutta pysyväksi
koko dokumentin tilaksi \koodi{\keno obey\-cr} ei yleensä sovi.
...
\koodimargin{\keno text\-quote\-dbl} \koodimargin{\keno
  text\-quote\-single} Yksittäinen gra\-vis\-ak\-sent\-ti (\`{}) tehdään
komennolla \koodi{\keno `\{\}}. Lainausmerkkien merkintätapoja ja
komentoja on koottu taulukkoon \ref{tlk:erikoismerkit-lainaus}
...
Komento \koodi{\keno-} on tavutusvihje, joka neuvoo
