...
esimerkiksi makropaketin koodissa: \koodi{fil} sallii, että kirjoittaja
tai muu koodi syrjäyttää asetuksen; \koodi{filll} on ehdoton sääntö,
joka syrjäyttää muut.

Käytännöllisyyssyistä äärettömästi venyvä pituus ''\koodi{0mm plus
  1fill}'' on jo valmiiksi asetettu mittaan \mittam{fill}. Sitä on
kätevää käyttää esimerkiksi vaaka- ja pystysuuntaisia välejä latovien
komentojen \komento{hspace} ja \komento{vspace} kanssa:
