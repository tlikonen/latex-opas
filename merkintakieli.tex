...
fonttien yhteydessä luvussa \ref{luku/fontit-valistys}.
...
kenoviiva ja sanaväli (\komentox{komento}\komentojatko{\keno~}).
...
\label{luku/komennot-maarittely}
...
\ref{luku/komennot-maarittely}). Ympäristöjen määrittelykomennoilla on
...
\ref{luku/komennot-maarittely}), esimerkiksi seuraavalla tavalla:
