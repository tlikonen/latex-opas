...
eikä se ymmärrä poistaa gemenanumeroita (3624) käytöstä vaan latoo ne
sellaisenaan suunnilleen oikeaan paikkaan. Ylä- ja alaindeksejä
käytettäessä on siis aina syytä käyttää
\paketti{real\-scripts}\-/pakettia ja indeksit hallitsevaa Open Type
\=/fonttia. Fonttien ominaisuuksia voi tutkia käyttöjärjestelmän
komentotulkissa komennolla \koodi{otf\-info}.

% \begin{koodilohkosis}
%   otfinfo -f MyriadPro-Regular.otf
% \end{koodilohkosis}
