...
Komentojen ensimmäinen valinnainen argumentti on luku (\koodi{n}), joka
...
Komennon määrittelyssä on välillä hyötyä komennosta nimeltä \koodi{\keno
  ignorespaces}, joka jättää välit huomioimatta komennon jälkeen. Ilman
...
Monimutkaisiin komentoihin tarvitaan ehtorakenteita, ja ne saa
toteutettua If Then \=/paketin tarjoaman \koodi{\keno
...
paketin ohjekirjasta (\koodi{tex\-doc if\-then}).
