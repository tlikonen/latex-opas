...
Sanat tavutetaan eli katkaistaan automaattisesti rivien lopussa, jotta
rivit ja kappaleet saisi näyttämään tasapainoisilta. Lähtökohtaisesti
...
huolehtii tavutus\-asioista lainkaan. Ihan lopuksi, kun kaikki
muotoilu\-asetuksetkin ovat valmiina, hän tarkistaa koko tekstin ja
lisää tavutusvihjeitä, jos automaattinen tavutus teki virheitä tai jos
kappaleen latominen tasapainoiseksi niitä muuten vaatii.
...
Kirjainyhdistelmiin perustuvat säännöt auttavat mutta eivät yksinään
riitä suomen kieleen, ja esimerkiksi yhdyssanojen rajakohdat tuottavat
usein ongelmia. Sana \emph{alku\-osa} katkaistaan Latexin sääntöjen
mukaan kohdista \mbox{\emph{al-kuo-sa}}, joka on kyllä oikein
tavurakenteen kannalta. Käytännössä se on kuitenkin ongelmallinen, koska
myös yhdyssanan rajalla olisi tavutuskohta (\emph{al-ku-o-sa}) ja koska
sanaa ei pitäisi katkaista siten, että siitä jää yksittäinen kirjain eri
riville (\emph{o-sa}).
...
sitovaa yhdysmerkkiä, koska muitakin vaihtoehtoja on.
...
tavutuksen välimerkin jälkeen (mutta sallii muualta).
...
Esimerkiksi komennon nimen perässä olevat sanavälit syödään pois.
Seuraavassa esimerkissä sana \emph{Latex} ladotaan ehjänä, jos vain
\koodi{\keno ko\-men\-to} itsessään ei kirjoita mitään eikä vaikuta
tekstin latomiseen.
...
Aaltosulkeiden jälkeinen sanaväli säilyy. Komennon nimen ja argumenttien
