...
\koodi{\keno `\{\}}. Oletuksena myös tasalevyinen fontti (luku
...
yhdysmerkkiä, voi käyttää tasalevyistä fonttia, joka oletuksena kytkee
pois Latexin ajatusviivatoiminnon. Muita tapoja on esimerkissä
\ref{esim:pois-tex-liga}.

\begin{esimerkki*}
\begin{koodilohko}
  \addfontfeatures{Ligatures=TeXReset} % Fontista Tex-merkkaus pois.
  -{}-       % Estetään ajatusviiva.
  >{}>       % Estetään kulmalainausmerkit.
  \texttt{…} % Tasalevyinen fontti estää Tex-merkkauksen.
\end{koodilohko}
\caption{Keinoja Tex-merkkauskomentojen estämiseen. Komento \koodi{\keno
...
Type \=/fontin ominaisuutta. Jos käytössä oleva fontti ei sisällä
haluttujen merkkien ylä- tai alaindeksiä,
...
\marginpar{\TeX \\ \LaTeX} Merkit voi kirjoittaa
...
on komentoja ladontajärjestelmän logojen kirjoittamiseen: \koodi{\keno
...
Jos komento on jo olemassa, annetaan virheilmoitus. Toinen komento
...
komentoa \koodi{\keno value}. Seuraava esimerkki luo laskurin nimeltä
...
\paketti{tot\-count}\-/pakettia.\avctan{totcount} Paketti tarjoaa
