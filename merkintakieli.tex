...
\paketti{real\-scripts}\-/paketin avulla.\avusepkg{realscripts}
...
toteutettua \paketti{ifthen}\=/paketin\avusepkg{ifthen} tarjoaman
...
niistä ovat otsikoiden numerointia varten (\textenglish{\koodi{part},
  \koodi{chapter}, \koodi{section}, \koodi{paragraph}}). Sivunumeroita
varten on \koodien{page}\-/laskuri ja matemaattisten kaavojen
numerointiin \koodien{equation}\-/laskuri. Leijuvista kuvista ja
taulukoista (luku \ref{luku:leijuosat}) pidetään kirjaa laskureissa
\koodien{figure} ja \koodien{table}, ja alaviitteiden (luku
\ref{luku:alaviitteet} ) numerointi on laskureissa \koodien{footnote} ja
\koodien{mpfootnote}. Numeroidut luetelmat (luku \ref{luku:luetelmat})
...
Edellä mainituista laskureista ei yleensä tarvitse itse huolehtia, sillä
ne ovat vain tekniikkaa, joka toimii korkeamman tason toimintojen
taustalla. Joskus on kuitenkin käyttöä myös omille laskureille.
Laskureita käsitellään seuraavilla komennoilla. Laskurin nimi koostuu
kirjaimista, eikä sen alussa ole kenoviivaa niin kuin komentojen ja
mittojen alussa.

\begin{koodilohkosis}
  \newcounter{laskuri}       % luodaan uusi laskuri
  \setcounter{laskuri}{3}    % asetetaan laskurin arvoksi 3
  \addtocounter{laskuri}{1}  % lisätään laskurin arvoon 1
  \addtocounter{laskuri}{-1} % vähennetään laskurin arvosta 1
\end{koodilohkosis}
...
nimi. Laskurin voi tulostaa kirjainmuodossa, jos sen suuruus on 1--26.
...
\leijutlk{
  \begin{tabular}{ll}
    ...
    \midrule
    \koodi{\keno arabic\{…\}} & arabialainen luku: 1, 2, 3\ldots \\
    \koodi{\keno roman\{…\}} & roomalainen luku: i, ii, iii\ldots \\
    \koodi{\keno Roman\{…\}} & roomalainen luku: I, II, III\ldots \\
    \koodi{\keno alph\{…\}} & kirjain: a, b, c\ldots \\
    \koodi{\keno Alph\{…\}} & kirjain: A, B, C\ldots \\
    \koodi{\keno fnsymbol\{…\}} & symboli:
                                  \textasteriskcentered
                                  \textdagger
...
asian kuin komento \koodien{\keno arabic\{page\}}. Aina nämä eivät
kuitenkaan ole sama asia, ja \koodi{\keno the}\-/alkuinen komento voi
olla määritelty toisellakin tavalla. Tämän oppaan leijuvat taulukot
numeroidaan laskurilla \koodi{table}, mutta komento \koodi{\keno
  the\-table} tulostaa ensin pääluvun ja sen perään pisteen ja taulukon
numeron. Viimeisin taulukko oli numeroltaan \thetable{} eli pääluvun
\arabic{chapter} taulukko \arabic{table}.
...
komentoa \koodien{\keno value}. Seuraava esimerkki luo laskurin nimeltä
...
kun sivu vaihtuu eli laskurin \koodien{page} arvo kasvaa.

\begin{koodilohkosis}
  \newcounter{oma}[page]
\end{koodilohkosis}

Hierarkkisia ylemmän tason laskureita ei kannata kasvattaa komennolla
\koodi{\keno add\-to\-counter}, koska se vain muuttaa laskurin arvoa
mutta ei huolehdi alemman tason laskurien nollaamisesta. Hierarkkisten
laskurien kasvattamiseen on seuraavat kaksi komentoa.
...
Makropaketti \paketti{chngcntr}\avusepkg{chngcntr} auttaa hierarkkisten
eli toisista laskureista riippuvien laskurien muuttamista jälkikäteen.
Paketin komentojen avulla voi jälkikäteen asettaa jonkin laskurin
riippuvaiseksi toisesta laskurista tai poistaa riippuvuuden.
...
komennon versioita: \koodi{\keno counter\-within*} ja \koodi{\keno
