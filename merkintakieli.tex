...
jotkin toiminnot ovat voimassa vain ympäristön sisällä.
...
Komento \koodi{\keno newenvironment} määrittelee uuden ympäristön mutta
antaa virheilmoituksen, jos samanniminen on jo olemassa. Komento
\koodi{\keno renewenvironment} puolestaan määrittelee uudelleen
...
\ref{luku:komennot_määr}). Ympäristöjen määrittelykomennoilla on kolme
...
komennoillekin (luku \ref{luku:komennot_määr}). Ensimmäinen valinnainen
...
ne eivät salli, että ympäristölle annetut argumentit sisältävät enemmän
kuin yhden tekstikappaleen. Toiminta on siis sama kuin komentojen
määrittelyssä (luku \ref{luku:komennot_määr}).
