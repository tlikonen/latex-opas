...
\paketti{show\-hy\-phens}\-/paketin.\avctan{showhyphens} Kaikkiin
dokumentin sanojen tavutuskohtiin piirretään ohut punainen pystyviiva,
mikä voi auttaa tavutusvihjeiden suunnittelussa. Tämä paketti hyödyntää
...
\emph{uo}\-/diftongista, vaan yhdyssanan rajalla on myös tavutuskohta
(\emph{al-ku-o-sa}). Lisäksi sanaa ei saa katkaista siten, että siitä
jää yksittäinen kirjain eri riville (\emph{o-sa}).
