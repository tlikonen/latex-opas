...
Edellä kuvattuihin Latexin omiin lainausmerkkien merkintätapoihin
(\koodi{''}, \koodi{>>} ym.) voi vaikuttaa \paketti{fontspec}\-/paketin
ja fontin asetusten avulla. Merkintätapoja kutsutaan
Tex\-/ligatuureiksi. Fonteissa on yleensä oletuksena asetus
...
\footnote{Tasalevyiselle fontille saa tavutuksen päälle fontin
  asetuksella \koodi{Hyphen\-Char=\{-\}}.}
