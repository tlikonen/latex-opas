...
asioissa hieman eri tavalla, ja eroja mainitaan tekstin lomassa.
...
Varsinainen tavutuksen peruskomento on \koodi{\keno dis\-cre\-tionary},
joka mahdollistaa omanlaisten tavutuskohtien määrittelyn. Komento
kirjoitetaan sanassa juuri siihen kohtaan, johon tavutuskohta halutaan.
Komennolle annetaan kolme argumenttia järjestyksessä seuraavasti: 1)
rivin loppuun ladottava teksti, 2) seuraavan rivin alkuun ladottava
teksti ja 3) katkaisemattomaan sanaan ladottava teksti. Normaali
tavutuskohta sanaan \emph{tavu} määriteltäisiin alla olevan esimerkin
tavoin.
...
Edellisessä esimerkissä ensimmäinen argumentti on vain yhdysmerkki,
...
sitä ei tiedä, ellei ole kokemusta. Yhdenkin tavutusvihjeen avulla koko
sanan tavutus otetaan omaan hallintaan (vain \paketti{polyglossia}).
...
(\koodi{\keno-}). Kaikki yleisten tavutussääntöjen mukaiset
tavutuskohdat saa käyttöön \paketti{extdash}\-/paketin komennoilla
(taulukko \ref{tlk:extdash}).
...
\koodi{\keno dis\-cre\-tionary}\-/komentoa voi hyödyntää suomen kielen
sanoissa silloin, kun niissä on heittomerkki erottamassa kahta tavurajan
molemmin puolin olevaa samaa vokaalia, esimerkiksi sanassa \emph{vaa'an}
ja \emph{liu'uttaa}. Normaalisti Latex ei katkaise heittomerkin kohdalta
lainkaan, eikä se ole suomen kielessä suositeltavaakaan. Jos tavutuksen
...
Nyt komennon kolmas argumentti on heittomerkki, koska se pitää latoa
...
yksinkertaisempi komento. jota sitten käytettäisiin heittomerkin
kohdalla.
...
Mikäli tällainen tavutuskohta halutaan mukaan, käytetään sanassa
tavallista tavutusvihjettä: \koodi{show'\keno-hun}. Mieluummin ei
kuitenkaan katkaista sanoja heittomerkin kohdalta.

Yleisesti tavutuksen hallintaa voi lähestyä ainakin kahdesta eri
suunnasta. Joku ehkä haluaa kirjoittaa dokumentin sisällön valmiiksi
ilman, että huolehtii tavu\-tus\-asiois\-ta lainkaan. Ihan lopuksi, kun
kaikki tekstin rivittämiseen liittyvät asetukset ovat valmiina, hän
tarkistaa koko tekstin ja lisää tavutusvihjeitä, jos automaattinen
tavutus teki virheitä tai jos kappaleen latominen tasapainoiseksi niitä
muuten vaatii.
