...
\leijukuva{
  \begin{tikzpicture}
    ...
    \node at (6.52,.74) {\fontsize{172bp}{172bp}\selectfont H};
...
(1\,ex). Optisen vaikutelman vuoksi gemenalinja ei tarkoita ehdotonta
...
versaalilinjan yli ja ylälinjan tuntumaan.
...
aavistuksen verran linjojen ylä- ja alapuolelle. Alla on tästä
esimerkki.
...
\begin{tulossis}
  x-korkeus: 5.45096pt, o-korkeus: 5.55214pt
\end{tulossis}
