...
\pakettim{realscripts}\-/ paketin avulla.\avctan{realscripts}
...
kuin komento \komento[\{page\}]{arabic}. Aina nämä eivät kuitenkaan ole
sama asia, ja \komentox{the}\-/alkuinen komento voi olla määritelty
toisellakin tavalla. Esimerkiksi tämän oppaan leijuvat taulukot
numeroidaan laskurilla \laskuri{table}, mutta komento \komento{thetable}
