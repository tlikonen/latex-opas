...
% Näitä merkkejä ei ole kaikissa tasalevyisissä fonteissa, joita
% tekstieditoreissa käytetään, ja silloin komennot \koodi{\keno
%   textsuperscript} ja \koodi{\keno textsubscript} voivat olla selvempi
% tapa merkitä ylä- ja alaindeksejä.
