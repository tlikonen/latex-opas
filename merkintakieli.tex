...
tarkoitetulla merkillä, jonka Unicode\-/tunnus on \unicode{u+00a0
  no-break space}.
...
yleisversio, niin sanottu \textsc{ascii}\-/lainausmerkki (\koodi{'}),
mutta se ei taida olla minkään kielen varsinainen lainausmerkki. On siis
syytä käyttää oikeita lainausmerkkejä, ja se käy Latexissa varsin
helposti.
