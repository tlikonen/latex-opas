...
\footnote{Näin toimii \paketti{polyglossia}\-/kielipaketti. Sen sijaan
  \paketti{babel}\-/paketti määrittelee suomen kielelle tavutusvihjeen
  (\koodi{\keno-}) siten, että se sallii sanan tavutuksen muistakin
  kohdista kuin tavutusvihjeen kohdalta. Tavutusvihjeen molemmin puolin
  sanan osat tavutetaan yleisten sääntöjen mukaisesti, ellei tavutuksen
  estäviä merkkejä kuten yhdysmerkkejä tai ajatusviivoja ole.}
...
ohjekirjoissa niitä kutsutaan nimellä \emph{\englanti{short\-hands}}.
