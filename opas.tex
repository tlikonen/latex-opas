...
\makeindex[name=paketit, title={Makropaketit}, columns=2, columnsep=1em,
intoc]
...
\newcommand{\komento}[1]{\koodi{\keno #1}\index[komennot]{\koodi{\keno #1}}}
\newcommand{\komentomargin}[1]{\marginaali{\koodi{\keno #1}}}
\newcommand{\ymparisto}[1]{\koodi{#1}\index[ymparistot]{\koodi{#1}}}
\newcommand{\ymparistomargin}[1]{\marginaali{\koodi{#1}}}

\newcommand{\tavukohta}{\textcolor{tavu}{\raisebox{-.2ex}{\rule{.6bp}{2ex}}}}
\newcommand{\uctunnus}[1]{\textsc{\englanti{#1}}}
\newcommand{\paketti}[1]{\textsf{#1}\index[paketit]{#1}}
