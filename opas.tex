...
\begin{center}
  ...
  {\addfontfeatures{LetterSpace=3, FakeStretch=1.8}\LaTeX ia}

  \vspace{1cm}

  \sffamily\fontsize{16}{16}\mdseries\upshape

  Nykyaikainen yleisopas 
  Latex-ladontajärjestelmään
\end{center}
...
{\sffamily\bfseries Nykyaikainen opas Latex-ladontajärjestelmään}
