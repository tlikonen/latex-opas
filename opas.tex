...
\setlength{\bibsep}{.5ex plus .2ex minus .1ex}
...
\newcommand{\avusepkg}[1]{\footnote{Käyttöönotto:
    \koodi{\keno usepackage\{#1\}}}}
...
\newcommand{\lahdetiedot}[4]{#1 #2: \emph{#3}. #4.}

\begin{teosluettelo}

\bibitem[Berry ym.(2018)]{unoffref} \lahdetiedot {\englanti{Berry, Karl
      \& Gilmore, Stephen \& Martinsen, Torsten}} {2018}
  {\englanti{Latex 2e: An unofficial reference manual}}
  {\englanti{October} 2018. Saatavissa:
    \kulmaurl{https://latexref.xyz/}}%
  \footnote{Tex Live \=/jakelussa komennolla: \koodi{texdoc latex2e}}
  Viittauspäivä 2.6.2020.

\bibitem[Itkonen(2015)]{kirjtyypit} \lahdetiedot {Itkonen, Markus}
  {2015} {Kirjaintyypit ja tyyli} {\textsc{rps}-yhtiöt}

\bibitem[Itkonen(2019)]{typokk} \lahdetiedot {Itkonen, Markus} {2019}
  {Typografian käsikirja} {Viides, tarkistettu painos. Typoteekki.
    Graafinen suunnittelu Markus Itkonen Oy}

\bibitem[Oetiker ym.(2005)]{pitkäjohdanto} \lahdetiedot {Oetiker, Tobias
    \& Partl, Hubert \& Hyna, Irene \& Schlegl, Elisabeth \& Hell\-gren,
    Timo} {2005} {Pitkänpuoleinen johdanto Latex 2ε:n käyttöön. Eli opi
    Latex 2ε 133 minuutissa} {Versio 4.17fi, lokakuu 2005. Saatavissa:
    \kulmaurl{https://www.ctan.org/pkg/lshort-finnish}}%
