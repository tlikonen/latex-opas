...

{
  ...
  Täsmennys lisenssiin: Jos ladot tämän teoksen Latex\-/kielisen tai
  muun lähdetiedoston elektroniseksi dokumentiksi (esim. \textsc{pdf}),
  ...
  elektronisen dokumentin käyttäjille selvästi, jos upotetut fontit
  rajoittavat käyttöä enemmän kuin tämä lisenssi ja että tämä lisenssi
  on silti voimassa sisällön osalta.
