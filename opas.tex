...
\makeindex[name=paketit, title={Paketit}, columns=2, columnsep=1em, intoc]
\makeindex[name=komennot, title={Komennot}, columns=2, columnsep=1em, intoc]
\makeindex[name=ymparistot, title={Ympäristöt}, columns=2, columnsep=1em, intoc]
\makeindex[name=mitat, title={Mitat}, columns=2, columnsep=1em, intoc]
