...
\usepackage{lmodern} % Vähentää fonttivaroituksia kääntämisessä.
\usepackage{fontspec}
...

{
  ...
  Poikkeus lisenssiin: Jos ladot tämän teoksen Latex\-/kielisen tai muun
  lähdetiedoston sähköiseksi dokumentiksi (esim. \textsc{pdf}),
  dokumenttiin mahdollisesti upotettavat fontit eivät kuulu tämän
  lisenssin piiriin, eli niillä saa olla jokin toinen lisenssi. Ilmaise
  sähköisen dokumentin käyttäjille selvästi, jos upotetut fontit
  rajoittavat käyttöä enemmän kuin tämä lisenssi ja että tämä lisenssi
  on silti voimassa teoksen muun sisällön osalta.
