...
\renewcommand{\footnotesize}{\fontsize{11.34bp}{14bp}\selectfont}
\renewcommand{\small}{\fontsize{12.6bp}{15bp}\selectfont}
\renewcommand{\normalsize}{\fontsize{14bp}{18bp}\selectfont}
\renewcommand{\large}{\fontsize{16.8bp}{21.6bp}\selectfont}
\renewcommand{\Large}{\fontsize{20.16bp}{22bp}\selectfont}
\renewcommand{\LARGE}{\fontsize{24.192bp}{26bp}\selectfont}
\renewcommand{\huge}{\fontsize{29bp}{32bp}\selectfont}
\renewcommand{\Huge}{\fontsize{34bp}{36bp}\selectfont}
\linespread{1}
\normalsize
...
\setlength{\skip\footins}{20bp}
\setlength{\floatsep}{.8cm}
\setlength{\textfloatsep}{1cm}

\setlength{\bibhang}{\parindent}
\setlength{\bibsep}{5bp}
\bibliographystyle{plainnat}
\setcitestyle{authoryear,comma,aysep={},yysep={,},notesep={: }}%
...
{\sffamily\versaalinum\fontsize{9bp}{9bp}\selectfont\arabic{FancyVerbLine}}

\DefineVerbatimEnvironment{koodilohko}{Verbatim}{ fontsize=\small,
  gobble=2, frame=single, framesep=6bp, numbers=left, numbersep=.3em,
...
\newcommand{\tavukohta}{\textcolor{tavu}{\rule{1bp}{1.5ex}}}
...
\begin{teosluettelo}
\bibitem[Berry ym.(2018)]{unoffref} Berry, Karl \& Gilmore, Stephen \&
...
\bibitem[Itkonen(2015)]{kirjtyypit} Itkonen, Markus 2015. Kirjaintyypit
  ja tyyli. RPS-yhtiöt.
\bibitem[Itkonen(2019)]{typokk} Itkonen, Markus 2019: Typografian
  käsikirja. Viides, tarkistettu painos. Typoteekki. Graafinen
  suunnittelu Markus Itkonen Oy.
\bibitem[Oetiker ym.(2005)]{pitkäjohdanto} Oetiker, Tobias \& Partl,
