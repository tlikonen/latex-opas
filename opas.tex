...
\defaultfontfeatures[\ttfamily]{Ligatures=TeXReset, HyphenChar={-}}
\defaultfontfeatures[\rmfamily,\sffamily]{Ligatures=TeX, Numbers=Lowercase}
%\usepackage[oldstyle]{libertinus-otf}

\setmainfont {Linux Libertine O}
\setsansfont {Linux Biolinum O} [Scale=MatchLowercase]
\setmonofont {DejaVu Sans Mono} [Scale=MatchLowercase, LetterSpace=-1]
%\setmonofont {Linux Libertine Mono O} [Scale=MatchLowercase]

% \setmainfont {TeX Gyre Pagella}
% \setsansfont {TeX Gyre Heros} [Scale=MatchLowercase]
% \setmonofont {TeX Gyre Cursor} [Scale=MatchLowercase, LetterSpace=-4]
% %\setmonofont {DejaVu Sans Mono} [Scale=MatchLowercase, LetterSpace=-1]
