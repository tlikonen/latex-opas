...
\leijukuva{
  \begin{tikzpicture}
    [viiva/.style={line width=.7bp}, x=.01\textwidth, y=.01\textwidth,
    baseline=0pt]

    \newcommand{\tikzlistkpl}[1]{\draw (15,#1) -- ++(70,0) -- ++(0,15)
      -- ++(-60,0) -- ++(0,-5) -- ++(-10,0) -- (15,#1)}
    ...
    \draw (0,0) rectangle ++(100,7);
    \node at (50,3) {alapuolinen teksti};
