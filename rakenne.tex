...
\begin{koodilohko}
  \begin{enumerate}
  \setcounter{enumi}{3}
  \item Luetelma alkaa kohdasta neljä.
  \item Tässä on vielä viides
  \item ja kuudes kohta.
  \end{enumerate}
\end{koodilohko}
\begin{tulos}
  \begin{enumerate}
  ...
  \end{enumerate}
\end{tulos}
\caption{Numeroitujen \ymparisto{enumerate}\-/ luetelmien laskurin voi
  asettaa itse}
\label{esim:luetelmalaskuri}
\end{esimerkki*}
...
\laskuri{enumi} haluamaansa arvoon \ymparisto{enumerate}\-/ ympäristön
sisällä esimerkin \ref{esim:luetelmalaskuri} mukaisesti.
...
Edellä mainitut komennot on syytä sijoittaa luetelmaympäristön sisään
heti \komento{begin}\-/ komennon jälkeen.
