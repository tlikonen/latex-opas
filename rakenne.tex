...
(luku \ref{luku:leijuosat_latex}), mutta \pakettim{floatrow}\-/ paketin
avulla niitä voi tehdä muitakin (luku \ref{luku:leijuosat_omat}).
...
Komennon ensimmäinen argumentti \koodil{tyyppi} on leijuvan osan tyyppi
ja käytännössä myös ympäristön nimi. Jos tyypiksi antaa sanan
\koodil{esimerkki}, syntyy leijuvat ympäristöt \ymparistox{esimerkki} ja
\ymparistox{esimerkki*}. Argumentin \koodil{valitsimet} avulla voi
...
tyyppinä. Valitsimella \koodil{placement} tehdään sijoitteluasetuksia,
joita käsitellään luvussa \ref{luku:leijuosat_sijoittelu}. Käytännössä
ne ovat tiettyjä kirjaimia, joilla vaikutetaan leijuvan osan
sijoitteluun. Oletusarvo on \koodil{tbp}.
...
numeroinnin riippuvuuteen muista laskureista. Oletuksena leijuvan osan
laskuri ei ole riippuvainen muista laskureista eli osat numeroidaan
dokumentin alusta saakka yhdellä luvulla. Arvoksi voi antaa myös Latexin
laskurin nimen: mielekkäitä arvoja ovat esimerkiksi \laskuri{chapter} ja
...
\ref{luku:leijuosat_omat}) luettelo tehdään \paketti{floatrow}\-/
...
pääte. Tyyppi \koodil{lot} (\englantik{list of tables}) on taulukoille
ja tyyppi \koodil{lof} (\englantik{list of figures}) on kuville. Omilla
...
hallintaan ja muokkaamiseen tarvitaan paketteja
...
\begin{table*}
  \floatbox{table}[\FBwidth]{
    ...
    \label{tlk:upea_taulukko}  % tunniste ristiviittausta varten
  }{
    \begin{tabular}{ll}
      jotain & soluja \\
      esimerkin & vuoksi \\
...
\end{koodilohko}
  ...
  \label{esim:floatbox_perus}
\end{esimerkki*}

Valinnaisen argumentin \koodil{leveys} voi jättää poiskin, jolloin
...
sisällön levyiseksi. Esimerkki \ref{esim:floatbox_perus} selventää,
...
\newcommand{\leijukuva}[2]{%
  ...
  \end{figure*}}
\end{koodilohko}
  \caption{Leijuvien osien toteutus omien komentojen avulla}
  \label{esim:floatbox_oma_ymparisto}
\end{esimerkki*}

Usein lienee järkevää määritellä oma komento tai ympäristö, joka
sisältää tarvittavat leijuvat ympäristöt ja \komento{floatbox}\-/
komennon. Näin ei tarvitse kirjoittaa niin paljon samoja komentoja.
Esimerkki \ref{esim:floatbox_oma_ymparisto} määrittelee kaksi komentoa,
\komentox{leiju\-tlk} ja \komentox{leiju\-kuva}, joilla on helppoa luoda
leijuva taulukko tai kuva, esimerkiksi seuraavalla tavalla:

\komentoi{caption}
\begin{koodilohkosis}
\leijutlk{\caption{Kuvateksti}}{varsinainen taulukko}
\end{koodilohkosis}
...
annetaan yksi argumentti, joka voi sisältää useita pilkulla toisistaan
erotettuja valitsimia ja niiden arvoja.
...
\leijutlk{
  ...
  \begin{tabularx}{\linewidth}{lL}
    ...
    \rivi{font}{fonttiasetukset:
      \koodi{rm}, \koodi{sf}, \koodi{tt}, \koodi{md}, \koodi{bf},
      \koodi{up}, \koodi{it}, \koodi{sl}, \koodi{sc},
      \koodi{scriptsize}, \koodi{footnotesize}, \koodi{small},
      \koodi{normalsize}, \koodi{large}, \koodi{Large}}

    \rivi{justification}{tasaus: \koodi{justified},
      \koodi{centering}, \koodi{raggedright}, \koodi{raggedleft},
      \koodi{RaggedRight} (\paketti{ragged2e}),
      \koodi{RaggedLeft}  (\paketti{ragged2e})}
  ...
  \caption{Muutama \komento{floatsetup}\-/ komennon valitsin, joilla
    ...
    \paketti{ragged2e}}
  \label{tlk:floatsetup_valitsimia}
}

Valinnainen argumentti \koodil{tyyppi} on leijuvan osan tyyppi,
...
kaikentyyppisiä leijuvia osia. Asetukset tehdään valitsimien avulla,
joita on olemassa paljon. Niistä muutama on koottu taulukkoon
\ref{tlk:floatsetup_valitsimia}.

Valitsin \koodil{font} asettaa leijuvan ympäristön fontin mutta ei
vaikuta kuvatekstiin. Fonttiasetukset ovat käytännössä avainsanoja,
jotka vastaavat lähes samannimisiä fonttikomentoja. Niitä käsiteltiin
luvussa \ref{luku:fontit_korkea}. Omiakin fonttien avainsanoja voi luoda
komennolla \komento{DeclareFloatFont}. Valitsimen \koodil{justification}
arvoksi annetaan myös tietty sana, joka vastaava samannimisiä palstan
tasauskomentoja (luku \ref{luku:kappaleen_tasaus}). Käytännössä leijuvan
