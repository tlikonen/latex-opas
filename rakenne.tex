...
\section{Kuvat KESKEN}
\label{luku/grafiikka}

Perus Latex ei pysty juuri minkäänlaiseen kuvien eli tietokonegrafiikan
käsittelyyn, mutta sopivan makropaketin avulla voidaan käsitellä
esimerkiksi kuvatiedostoja helposti. Myös omia vektorigrafiikkakuvia voi
piirtää Latex\-/ komentojen avulla, kun lataa siihen tarkoitetun
ulkoisen makropaketin. Tässä alaluvussa neuvotaan ensin kuvatiedostojen
käsittelyä ja sitten muita grafiikantuottamiskeinoja.

\subsection{Kuvatiedostot KESKEN}
...
\leijutlk{
  ...
  \begin{tabularx}{\textwidth}{lL}
    ...
    \ots{Valitsin} & \ots{Merkitys} \\
    \midrule
    \rivi{width}{kuvan leveysmitta}
    \rivi{height}{kuvan korkeusmitta}
    \rivi{angle}{kuvan kääntökulma asteina}
    \rivi{origin}{kuvan kääntämisen keskipiste:
      \koodi{c} (keskikohta),
      \koodi{l} (vasen),
      \koodi{r} (oikea),
      \koodi{t} (ylä),
    ...
    \rivi{trim}{kuvan reunaviivojen siirto: vasen, ala, oikea, ylä}
    \rivi{clip}{kuvan leikkaaminen päälle}
    \bottomrule
  \end{tabularx}
}{
...
\subsection{Vektorigrafiikan piirtäminen KESKEN}
