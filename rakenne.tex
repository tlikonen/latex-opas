...
Valitsinta \koodil{!} käytetään yhdessä muiden valitsimien kanssa, ja se
poistaa tietyt sijoitteluun vaikuttavat säännöt tai rajoitukset. Tähän
liittyvät rajoitukset tulevat \koodi{number}-loppuisista laskureista ja
\koodi{fraction}\-/ loppuisista komennoista, joita käsitellään
seuraavaksi.

% \textfloatsep, \floatsep, \intextsep, \bottomfraction,
% \floatpagefraction, \textfraction, \topfraction, bottomnumber,
% dbltopnumber, topnumber, totalnumber.
%
% \dbltopfraction, \dblfloatpagefraction, dblfloatsepå, dbltextfloatsep,
