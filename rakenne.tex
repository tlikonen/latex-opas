...
paketin avulla. Paketti \pakettim{hyperref}\avctan{hyperref}
...
käyttämällä apuna pakettia \paketti{titlesec}\avctan{titlesec} ja
...
paketin \pakettim{floatrow}\avctan{floatrow} voi käyttää myös myös
...
Paketti \paketti{natbib}\avctan{natbib} laajentaa Latexin
...
Laajennettujen tyylien käyttäminen ei vaadi erillisen paketin
