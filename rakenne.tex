...
arvo kuten tavallisestikin eli komennolla \komento{setcounter} (luku
\ref{luku:laskurit}). Näiden laskurien vaikutuksen voi poistaa kokonaan
käyttämällä leijuvan ympäristön valitsinta \koodil{!} (taulukko
...
Seuraavat neljä komentoa sisältävät desimaaliluvun 0\==1. Luku liittyy
leijuvien osien ja leipätekstin suhteelliseen määrään samalla sivulla.
Komennot määritellään uudelleen komennolla \komento{renewcommand} (luku
\ref{luku:komennot_maarittely}). Näiden vaikutuksen voi poistaa kokonaan
leijuvan ympäristön valitsimella \koodil{!} (taulukko
\ref{tlk:leijuosat_sijoittelukirjaimet}).
...
\komento{dblfloatpagefraction}


% \clearpage, \cleardoublepage ja \chapter. placeins-paketti
