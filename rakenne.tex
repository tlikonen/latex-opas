...
Plus-, jako- ja yhtäsuuruusmerkki ($+:/=$) sekä pienempi kuin ja
suurempi kuin \=/merkit ($<\,>$) kirjoitetaan näppäimistöltä
...
\uctunnus{u+2032 prime}. Seuraavassa esimerkissä mukana oleva
\mkomento{quad}\-/ komento latoo pienen vaakasuuntaisen välin.
...
Nuoliaksentit eli esimerkiksi vektorien nimissä tarvittavat komennot
ovat taulukossa \ref{tlk/matem-nuoliaksentit}.

Relaatioita ja operaattoreita on puolestaan taulukoissa
\ref{tlk/matem-relaatioita}, \ref{tlk/matem-operaattoreita} ja
\ref{tlk/matem-suuret-oper}. Nuolia, erotinmerkkejä ja sekalaisia muita
symboleja on taulukoissa \ref{tlk/matem-nuolet},
\ref{tlk/matem-erottimia} ja \ref{tlk/matem-sekalaisia}.
...
\leijutlk{
  ...
  \caption{Suurikokoisia operaattoreita}
...
\leijutlk{
  ...
  \begin{tabular}{*{3}{cl}}
    ...
    % KESKEN: 3.10 miscalleneous symbols
...
% latexsym-paketissa lisää symboleja

% Samaan taulukkoon nuoliaksenttien kanssa: \overline \underline
% \underbrace \overleftarrow
%
% matriisi
