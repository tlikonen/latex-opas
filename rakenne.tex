...
\begin{table}
  \begin{floatrow}[2]
    \floatbox{table}[\FBwidth]{
      \caption{Vasemmanpuoleinen taulukko}
    }{
      \begin{tabular}{ll}
        soluja & vain \\
        esimerkin & vuoksi \\
    ...
    \floatbox{table}[\FBwidth]{
      \caption{Oikeanpuoleinen taulukko}
    }{
      \begin{tabular}{ll}
        soluja & vain \\
        esimerkin & vuoksi \\
...
\end{table}
\end{koodilohko}
  \caption{\ymparisto{floatrow}\-/ ympäristöllä voi latoa samaan
    leijuvaan osaan useita taulukoita, kuvia tms. Niistä jokainen
    toteutetaan komennon \komento{floatbox} avulla ja jokaisella on oma
    kuvatekstinsä}
  \label{esim:floatrow_floatbox}
\end{esimerkki*}
...
komentoa. Esimerkki \ref{esim:floatrow_floatbox} selventää, kuinka
ladotaan kaksi taulukkoa rinnakkain.
