...
ympäristössä se on ''\figurename''. Näiden muuttamista käsitellään
asetusten yhteydessä luvussa \ref{luku:leijuosat_asetukset}.
...
automaattisesti otsikko kuten ''\listtablename'' ja ''\listfigurename''
ja automaattisesti sisältö eli kaikki \komento{caption}\-/ komennolla
...
''\tablename'' tai ''\figurename'' tulevat komennoista
