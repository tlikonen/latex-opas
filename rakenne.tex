...
jokaisen sanan kohdalla luetellaan sivunumerot, joilla kyseistä asiaa
käsitellään. Asiahakemistojen tarkoituksena on helpottaa tiedon
löytämistä. Tämän oppaan luku asiahakemistot alkavat sivulta
\pageref{luku/asiahakemisto}.
...
Kirjoittajan kannalta asiahakemiston toteutuksen perusajatus on
yksinkertainen: komennolla \komento{index} lisätään haluttuja asiasanoja
hakemistoon ja komennolla \komento{printindex} ladotaan varsinaiset
hakemistot. Näitä käsitellään erillisissä alaluvuissa.
...
joiden sukunimet ovat joko Varis tai Waris. Kaikki nimet aakkostetaan
nimen Varis mukaisesti, eli \emph{v} ja \emph{w} katsotaan aakkostuksen
kannalta samaksi kirjaimeksi. Tämä on tavallinen käytäntö suomalaisten
sanojen ja nimien aakkostuksessa.\footcite[26]{kt_oik}

\komentoi{index}
\begin{koodilohkosis}
\index{Varis, Jukka}
\index{Varis, Anita@Waris, Anita}
\index{Varis, Yrjö@Waris, Yrjö}
\end{koodilohkosis}

\begin{tulossis}
  Waris, Anita, \arabic{page} \\*
  Varis, Jukka, \arabic{page} \\*
  Waris, Yrjö, \arabic{page}
\end{tulossis}
...
Aina ei kuitenkaan ole mielekästä ilmaista aiheen käsittelyä usean
\komento{index}\-/ komennon avulla. Toisinaan voi olla sopivampaa
määrittää aiheen käsittelyn alku- ja loppukohta. Alkukohta ilmaistaan
\komento{index}\-/ komennon argumentissa merkkien \koodi{|(} avulla ja
loppukohta merkkien \koodi{|)} avulla. Jos aloitus ja lopetus sattuvat
samalle sivulle, hakemistoon ladotaan vain yksi sivunumero. Muussa
tapauksessa ladotaan sivualue. Seuraavassa on esimerkki aiheen
...
...
\index{asiasana|)}        % aiheen käsittely loppuun
\end{koodilohkosis}
...
Jos itse asiasanaan täytyy sisällyttää \koodi{@}-, \koodi{!}- tai
\koodi{|}-merkki, pitää niiden eteen kirjoitta yleislainausmerkki
(\koodi{\textquotedbl}), joka estää niiden tulkitsemisen
\komento{index}\-/ komennon erikoismerkiksi.

\subsection{Asiahakemisto ja asetukset}

...

% splitindex ja xindy: -shell-escape
