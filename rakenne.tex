...
Toinen vaihtoehto on sijoittaa taulukko vaakasuunnassa sivun keskelle,
jolloin se erottuu muusta tekstistä vielä selvemmin. Taulukkoympäristö
kirjoitetaan \ymparisto{center}\-/ ympäristön sisään
(\ref{luku:kappaleen_tasaus}).

Kolmas vaihtoehto on tehdä taulukosta ''leijuva'' eli antaa Latexin
sijoittaa se sopivaan paikkaan. Samalla taulukolle voidaan antaa
kuvateksti ja numero, niin että siihen voi viitata tekstistä. Leijuvia
osia ja ristiviitteitä käsitellään luvuissa \ref{luku:leijuosat} ja
...
sopii hyvin tähän tarkoitukseen. Tämän luvun esimerkeissä käytetään
paljon vaaka- ja pystyviivoja, jotta lukija hahmottaa helposti, miten
esimerkkikoodin solut ovat yhteydessä ladottuun taulukkoon.
...
kiinteäleveyksisillä \koodi{p}\-/ tyypin sarakkeilla. Seuraavassa
esimerkissä on yksi kaksirivinen solu:
...
alueelle. Tällaiseen tarvitaan \pakettim{multirow}\-/ pakettia ja sen
\komentom{multirow}\-/ komentoa. Komennon pakolliset argumentit ovat
seuraavat:
...
pystysuunnassa laajennettuun soluun. Komennolla on myös valinnaisia
argumentteja, jotka ilmaistaan hakasulkeiden avulla. Niistä ehkä tärkein
on ensimmäinen:
...
\subsection{Muita ympäristöjä ja mahdollisuuksia}
...
leveitä. Tämä ilmenee seuraavasta esimerkistä:
...
Saraketyypissä ''\koodi{X}'' teksti tasataan oletuksena molemmista
reunoista, mutta tähän on mahdollista vaikuttaa käyttämällä
sarakemäärittelyssä \koodi{>}\=/ merkkiä ja antamalla sen argumentiksi
sopivia asetuskomentoja. Seuraava sarakemäärittely tekee vasemmalle
tasatun \koodi{X}\=/ sarakkeen:
