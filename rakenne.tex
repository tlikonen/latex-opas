...
\subsection{Asiahakemistojen määrittely KESKEN}
...
käsitellään kyseisen komennon muita ominaisuuksia pakettien
\paketti{indextools} ja \paketti{imakeidx} näkökulmasta.
...
määräytyy kieliasetusten perusteella. Se on \paketti{polyglossia}\-/
kielipaketissa suomen kieliasetuksilla ''\indexname''.
...
Muita hakemistojen latomiseen liittyviä asetuksia käsitellään luvussa
