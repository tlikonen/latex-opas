...
tekee leijuvaan osaan (luku \ref{luku/leijuosat}) tai laatikkoon (luku
\ref{luku/laatikot}), se merkitään oletuksena kirjaimen avulla, ja
alaviitteen teksti ladotaan kyseisen osan alapuolelle.

% \footnotemark[n], \footnotetext[n]{...}

% \renewcommand{\thefootnote}{\alph{footnote}}
% \renewcommand{\thempfootnote}{\symbol{mpfootnote}}

% footmisc-paketti

Leipätekstin ja alaviitteet erotetaan pystysuuntaisella välillä, jonka
...
ominaisuudesta on aika harvoin mitään hyötyä, koska alaviite on melkein
aina samalla sivulla. Linkkitoiminto myös häiritsee eräitä
\paketti{footmisc}\-/ paketin toimintoja. Paketti on tarkoitettu
alaviitteiden typografian asetuksiin. Linkkitoiminnon voi kytkeä pois
\paketti{hyperref}\-/ paketin lataamisen yhteydessä seuraavalla
asetuksella:
