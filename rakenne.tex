...
Valitsimen \koodi{within} avulla vaikutetaan leijuvien osien
...
Latex osaa numeroida dokumentin otsikot eli luvut ja leijuvat osat
automaattisesti, eli se tietää, minkä numeron mikäkin dokumentin osa
saa. Niinpä Latex osaa -- kirjoittajan pienellä avustuksella -- myös
...
Ei siis ehkä kannata kirjoittaa ja ylläpitää tunnisteessa samaa tekstiä
kuin otsikossa tai kuvatekstissä. Otsikot voivat muuttua kirjoittamisen
aikana, ja samakin otsikko voi esiintyä dokumentissa eri paikoissa. Ei
ehkä myöskään kannata kirjoittaa otsikoiden tunnisteeseen tietoa, minkä
tasoisesta otsikosta on kyse (\komento{section}, \komento{subsection}
ym.). Joskus dokumentin jäsennyskin muuttuu kirjoittamisen aikana:
esimerkiksi alussa korkeatasoinen luku siirtyy myöhemmin toisen
laajemman kokonaisuuden osaksi eli alaluvuksi.
...
versio, jos sellainen on annettu. Katso lisätietoa otsikkokomentojen ja
kuvatekstikomennon argumenteista luvuista \ref{luku/otsikot}
