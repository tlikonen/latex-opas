...
sillä ilmaistaan sarakkeen kiinteä leveys.
...
\komento{multicolumn} voi tehdä rivikohtaisia poikkeuksia. Tässä
komentoa käsitellään myöhemmin. Merkki ''\koodi{@}'' tarvitsee
argumentin aaltosulkeissa. Se voi olla mitä hyvänsä tekstiä tai
komentoja, jotka halutaan suorittaa joka rivillä sarakkeiden välissä.
...
\end{koodilohko}
  ...
  \begin{tulos}
    \versaalinum
    \renewcommand{\arraystretch}{1.3}
    \begin{tabular}[t]{|l@{\hspace{4em}}r|c|}
      \hline
      Vasen & Oikea & Keskitetty \\
      \hline
      16 & 32 & 11732 \\
...
typografisensa esimerkkinä, mutta tarkoituksena on osoittaa eri
...
\komento{hline} ja lyhempiä viivoja komennolla \komento{cline}. Tälle
komennolle täytyy antaa yksi argumentti, joka sisältää kaksi
...
vasemmalta oikealle lukemista, ja tavallinen sarakkeiden välinen tyhjä
tila yleensä riittää. Se on hyvä yleisohje, mutta sitä tuskin kannattaa
pitää ihan ehdottomana sääntönä. Joskus on tarpeen jakaa sarakkeet
...
Kaikkien viivoja paksuus on mitassa \mittam{arrayrulewidth}, jonka
oletusarvo on 0,4\,pt.
...
Sarakemääritelmässä voi \koodi{@}\=/ merkillä säätää välit täysin
haluamansa laiseksi. Esimerkiksi merkeillä \koodi{@\{\}} sarakeväli
poistetaan kokonaan. Tätä tarvittaneen välillä taulukon vasemmassa ja
oikeassa reunassa. Jos \koodi{@\{\dots\}}\=/ määrittelyyn halutaan
mukaan normaali sarakkeiden pystyviiva, täytyy käyttää komentoa
...
soluun. Komennon ensimmäinen argumentti on luku ja ilmaisee, kuinka
monen sarakkeen alue varataan. Toinen argumentti sisältää uuden
sarakemäärittelyn tälle alueelle, ja se tehdään taulukon
\ref{tlk:taulukko_sarakemerkit} merkkien avulla. Kolmas argumentti on
teksti, joka sijoitetaan tähän uudella tavalla määriteltyyn
sarakkeeseen.

% \newline ja moniriviset p-sarakkeet
