...
komennoissa. Tähän tapaan omia tyylejä määrittelemällä säästää
...
\section{Esitysgrafiikka KESKEN}
...
\luokka{beamer},\avctan{beamer} joka on oma dokumenttiluokkansa. Sen
ohjekirjassa on reilu kaksisataa sivua, joten tässä oppaassa voidaan
esitellä vain perusasioita, joilla pääsee alkuun.
...
(engl. \englantik{center}), joka keskittää dian sisällön pystysuunnassa.
Tämän asetuksen voi muuttaa kuhunkin diaan käyttämällä
\ymparisto{frame}\-/ ympäristön valinnaista argumenttia, kuten esimerkin
rivillä 34 on tehty.
...
\subsection{Asetuksia KESKEN}

\luokka{beamer}\-/ dokumenttiluokka sisältää omat komentonsa esimerkiksi
fonttien, kirjainleikkausten ja värien valintaan. Fontit sinänsä
määritellään ja tuodaan dokumenttiin samalla tavalla kuin Latexissa
muutenkin (luku \ref{luku/kirjaintyypit}), mutta tietyn
kirjainleikkausten valitsemiseen esimerkiksi dian otsikkoon tai muihin
erityisiin kohtiin vaatii \luokka{beamer}\-/ luokan omia komentoja.

Edellisten lisäksi \luokka{beamer} sisältää valmiita ulkoasuteemoja.
Teemat ovat asetusten kokonaisuuksia, joita toimitetaan dokumenttiluokan
mukana ja joita voi tehdä itsekin. Käyttämällä valmista teemaa saa
helposti käyttöönsä jonkun suunnitteleman tyylikkään kokonaisuuden.
Tässä alaluvussa käsitellään ensin teemojen valintaa ja joitakin
dokumenttiluokan mukana toimitettavia valmiita teemoja. Vasta sen
jälkeen neuvotaan, kuinka fontteihin ja väreihin pääsee itse
vaikuttamaan.
...
liittyvää: kirjainleikkaukset, värit ja dian reunoille ladottavaa
lisätietoa. Alemmantasoisia teemakomentoja ovat \komento{usecolortheme}
ja \komento{usefonttheme}, joilla valitaan vain väri- tai
kirjainleikkausteema. Lisäksi on teemakomennot \komento{useinnertheme}
ja \komento{useoutertheme}, joilla valitaan dian reunoille ladottavaan
lisätietoon erikoistuneet teemat. Yleensä kyse on diaesityksen
otsikoihin ja kokonaisrakenteeseen liittyvästä lisätiedosta. Näiden
käytännön merkitys selviää parhaiten kokeilemalla vaihtoehtoja, joita
esitellään lyhyesti seuraavaksi.

\leijutlk{
  \begin{tabular}{lll}
    \toprule
    \komento{usetheme}
    & \komento{usefonttheme}
    & \komento{usecolortheme} \\
    \midrule
    ... \\
    \bottomrule
  \end{tabular}
}{
  \caption{\luokka{beamer}\-/ luokan teemanvalintakomentoja ja valmiita
    teemoja~(1)}
  \label{tlk/usetheme1}
}
...
\leijutlk{
  \begin{tabular}{ll}
    \toprule
    \komento{useinnertheme}
    & \komento{useoutertheme} \\
    \midrule
    ... \\
    \bottomrule
  \end{tabular}
...
Taulukoissa \ref{tlk/usetheme1} ja \ref{tlk/usetheme2} on
\luokka{beamer}\-/ luokan valmiita teemoja. Taulukon otsikkorivillä on
teeman valintakomento ja sen alla samassa sarakkeessa teeman nimiä,
joita voi antaa komennolle argumentiksi. Teemat valitaan kirjoittamalla
lähdedokumentin esittelyosaan teemakomentoja, esimerkiksi seuraavalla
tavalla:
...
voi lukea lisää dokumenttiluokan ohjekirjasta. Seuraavassa esimerkissä
... KESKEN
...
% Esitellään lyhyesti theme-komennot ja tehdään taulukoita, joissa vain
% listataan valmiita teemoja.
...
% \setbeamerfont{title}{series=\bfseries,family=\sffamily,size=\Huge}
% \setbeamerfont{frametitle}{series=\bfseries,family=\sffamily,size=\LARGE}
% \setbeamerfont{framesubtitle}{series=\bfseries,family=\sffamily,size=\footnotesize}
% \setbeamerfont{block title}{series=\bfseries,family=\sffamily,size=\large}
% \setbeamerfont{normal text}{family=\rmfamily}
% \setbeamerfont{footnote}{family=\rmfamily,size=\footnotesize}
...
% Mahdollisesti käsitellään teemat eri alaluvussa kuin
% template-asetukset.

\section{Kirjeet KESKEN}
\label{luku/kirjeet}
