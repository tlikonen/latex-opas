...
romaan pääluvut, ja ne saavat oletuksena numeroinnin ''Luku~1'',
...
\komentom{subsubsection} ovat tavallisimpa tekstin väliotsikoita. Nekin
...
monimutkaisia fontti- eikä muotoilukomentoja, vaan otsikon ulkoasu ja
muotoilu tehdään muilla keinoilla, joita esitellään alaluvussa
\ref{luku:otsikot_ulkoasu}. Yksinkertaiset korostuskomennot tai
tavutusvihjeet (\komento{-}) kuitenkin toimivat yleensä.
...
Edellä jo todettiin, että Latex numeroi otsikot automaattisesti ja lisää
ne ladottavaan sisällysluetteloon. Tähän on kuitenkin mahdollista
vaikuttaa. Laskuri \laskurim{secnumdepth} on tarkoitettu käyttäjän
asetettavaksi, ja sillä määritetään, mihin otsikkotasoon saakka otsikot
numeroidaan. Otsikoiden tasonumerot ovat taulukossa
\ref{tlk:otsikkotasot}. Seuraava esimerkki määrittelee, että vain
tasoon~1 (\komento{section}) saakka otsikot numeroidaan. Sen alapuolella
olevat (\komento{subsection} ym.) eivät saa numeroa.

\begin{koodilohkosis}
  \setcounter{secnumdepth}{1}
\end{koodilohkosis}

Toinen laskuri \laskurim{tocdepth} puolestaan määrittelee, mihin tasoon
saakka sisällysluettelossa näytetään otsikoita. Esimerkiksi romaanin
