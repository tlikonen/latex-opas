...
poluksi, ja sen lopussa täytyy olla puolipiste (\koodi{;}). Esimerkissä
on toinenkin polku eli toinen \komento{draw}\-/ komento piirtää
pystyviivan suuren kolmion keskelle ja jakaa sen kahdeksi pienemmäksi
kolmioksi.
...
kautta viivaa taivutetaan, sekä loppupisteen.
...
argumentteja. Värivalitsimien \koodi{color} ja \koodi{fill} arvoksi voi
...
(\koodi{line width}) ja väri (\koodi{color}). Näin määriteltyä
