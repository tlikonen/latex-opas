...
\ymparisto{tabular} ja \ymparisto{tabular*}. Jälkimmäisen tilalle sopii
usein paremmin \paketti{tabularx}\-/ paketin ympäristö
\ymparisto{tabularx}. Tässä alaluvussa käsitellään ensin taulukoiden
perusasiat \ymparisto{tabular}\-/ ympäristön avulla ja myöhemmin on
tietoa muista ympäristöistä. Taulukon luomisen perusrakenne on seuraava:
...
\ref{tlk:taulukko_sarakemerkit}. Taulukon neljä ensimmäistä merkkiä
''\koodi{lcrp}'' määrittelevät sarakkeen tyypin. Syntyvässä taulukossa
tulee olemaan niin monta saraketta kuin näitä merkkejä on ympäristön
''\koodi{sarakkeet}''\-/ argumentissa. Kolme ensin mainittua merkkiä
luovat sarakkeen, jonka leveys määräytyy sarakkeen leveimmän solun
perusteella. Neljäs eli saraketyyppi ''\koodi{p}'' tarvitsee
aaltosulkeissa argumentiksi Texin mitan (luku \ref{luku:mitat}), ja
sillä ilmaistaan sarakkeen kiinteä leveys. Tässä saraketyypissä teksti
tasataan solun molemmista reunoista eli sanavälejä voidaan venyttää.

Merkit ''\koodi{|}'' ja ''\koodi{@}'' voi sijoittaa edellä mainittujen
sarakemerkkien väliin tai ennen ensimmäistä saraketta tai viimeisen
...
komentoon. Rivinvaihtokomennolle voi antaa hakasulkeissa yhden
argumentin. Se on mitta, jolla ilmaistaan ylimääräistä tyhjää tilaa
rivin jälkeen.
...
Esimerkin \ref{esim:taulukkomaarityksia} koodin ensimmäisellä rivillä
määritellään uudelleen komento \komentom{arraystretch}. Komennon
määritelmässä pitää olla luku, joka tarkoittaa taulukoiden sisäistä
rivivälikerrointa. Oletusarvo on~1, mutta usein taulukon rivit vaativat
hieman harventamista eli suurempaa lukua -- varsinkin jos on käytetty
vaakaviivoja.

Taulukkojen ulkoasua ja helppolukuisuutta käsittelevät ohjeet yleensä
sanovat, että pystyviivoja ei pitäisi juuri käyttää. Ne häiritsevät
vasemmalta oikealle lukemista. Tavallinen sarakkeiden välinen tyhjä tila
yleensä riittää. Se on hyvä yleisohje, mutta sitä tuskin kannattaa pitää
ihan ehdottomana sääntönä. Joskus on tarpeen jakaa sarakkeet
mielekkäisiin ryhmiin ja nimenomaan ohjata katsetta pystysuunnassa
tiettyjä sarakkeita pitkin. Usein kuitenkin pelkät vaakaviivat
riittävät. Tämän alaluvun esimerkeissä kuitenkin käytetään paljon
viivoja, jotta lukija hahmottaa helpommin taulukon rivit ja sarakkeet.

Sarakkeiden määritelmään voi kirjoittaa useitakin pystyviivoja eli
...
kertaa jokaisen sarakkeen väliin. Oletusarvo on 6\,pt.
...
Poikkeuksellista sarakeväliä käytetään välillä desimaalilukujen kanssa,
koska allekkain olevat desimaaliluvut on mielekästä tasata
desimaalipilkun kohdalta. Se toteutetaan määrittämällä sarakkeiden
väliksi joko pilkku tai tyhjä, kuten esimerkissä
\ref{esim:taulukko_desimaalipilkku} on tehty. Viereiset sarakkeet
tasataan tätä pilkkua vasten.

Esimerkissä \ref{esim:taulukko_desimaalipilkku} käytetään myös komentoa
\komentom{multicolumn}, jolla voi luoda poikkeuksellisia
sarakemäärityksiä. Tässä esimerkissä sen avulla sarakkeen otsikko
''Tulokset'' yltää kahden sarakkeen alueelle ja teksti tasataan sen
alueen vasempaan reunaan~(\koodi{l}). Lisäksi komennon avulla jätetään
taulukon pystyviivat pois otsikkoriviltä.
...
Yhteen soluun voidaan tietyissä tilanteissa latoa useampia rivejä.
...
pyritään jakamaan useammalle riville ja sanoja mahdollisesti katkaistaan
tavurajojen kohdalta. Myös \komentom{newline}\-/ komennolla voi vaihtaa
riviä yksittäisen solun sisällä. Tämäkin toimii vain
kiinteäleveyksisillä \koodi{p}\-/ tyypin sarakkeilla.
...
alueelle. Tällaiseen tarvitaan \pakettim{multirow}\-/
pakettia\avctan{multirow} ja sen \komentom{multirow}\-/ komentoa.
Komennon pakolliset argumentit ovat seuraavat:
...
Ensimmäisen argumentin ''\koodi{n}'' avulla ilmaistaan, kuinka monen
...
Kolmas argumentti on teksti, joka ladotaan soluun. Komennolla on myös
valinnaisia argumentteja, jotka ilmaistaan hakasulkeiden avulla. Niistä
ehkä tärkein on ensimmäinen:

\komentoi{multirow}
\begin{koodilohkosis}
\multirow[sijainti]{n}{leveys}{teksti}
\end{koodilohkosis}
...
Komennon muista valinnaisista argumenteista ja mahdollisuuksista
kannattaa lukea \paketti{multirow}\-/ paketin ohjekirjasta. Esimerkki
\ref{esim:taulukko_multirow} havainnollistaa komennon peruskäyttöä.
Komento \komento{multirow}\-/ kirjoitetaan siihen soluun, josta
monirivinen solu alkaa. Sen alapuolelta täytyy jättää riittävä määrä
soluja tyhjäksi.
...
Valitettavasti taulukon leveysmittaa (\koodi{leveys}) voi hyödyntää vain
rajallisesti. Se vaikuttaa taulukon leveyteen silloin, kun sarakkeiden
välit on määritelty venyviksi käyttämällä seuraavaa sarakevälin
määritystä:
...
siis kaiken vapaana olevan tilan ja ovat oletuksena keskenään yhtä
leveitä.
...
Saraketyypissä ''\koodi{X}'' teksti tasataan molemmista reunoista, mutta
tähän on mahdollista vaikuttaa käyttämällä sarakemäärittelyssä
\koodi{>}\=/ merkkiä ja antamalla sen argumentiksi sopivia
asetuskomentoja. Seuraava sarakemäärittely tekee vasemmalle tasatun
\koodi{X}\=/ sarakkeen:
...
otsikkorivejä ilmaisevaan saraketyyppiin ''\koodi{O}'' voitaisiin
laittaa fonttikomento, jotta koko sarake ladotaan automaattisesti eri
kirjainleikkauksella kuin muu taulukko.

\komentoi{newcolumntype}
\komentoi{bfseries}
\begin{koodilohkosis}
\newcolumntype{O}{>{\bfseries}l}
\end{koodilohkosis}
...
% tabulary, longtable(?)
% booktabs
% taulukoiden väritys xcolor-paketin avulla
