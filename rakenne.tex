...
\ymparisto{math} sisälle. Tässä oppaassa käytetään jatkossa aina
\komento{(} \komento{)} \=/komentoja, mutta seuraavassa on esimerkki
kaikista kolmesta:
...
\noindent
Kehittyneempiä matematiikkaympäristöjä on paketissa
\paketti{amsmath}.\avctan{amsmath} Esimerkiksi \ymparisto{align}\-/
ympäristöllä pystyy tasaamaan allekkaiset kaavat tietystä kohdasta.
Tasauskohta ilmaistaan lähdedokumentissa \koodi{\&}\-/ merkillä, joka
toimii hieman samalla tavalla kuin taulukoiden (luku
\ref{luku/taulukot}) sarake\-/ erottimet.
