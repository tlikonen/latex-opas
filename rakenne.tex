...
\label{luku/pystysuuntaiset-valit}
...
\ref{luku/venyvat-mitat}.

\subsection{Ensimmäisen rivin sisennys}
\label{luku/ensimmaisen-rivin-sisennys}
...
\ref{luku/ymparistot}. Esimerkin \ref{esim/vasen-oikea-sisennys} rivillä
...
\ref{luku/fontit-korkea}. \marginaali{Katso fonttikomentoja taulukosta
...
asetuksilla. Luvuissa \ref{luku/fontit-valistys} ja
...
ohjeita on luvussa \ref{luku/fontit-valistys}.
...
määritelty (luku \ref{luku/yla-ala-tunnisteet}). Täysin tyhjän sivun saa
...
\ref{luku/venyvat-mitat}), jotta Tex saa pelivaraa sivujen latomiseen.
...
\ref{luku/ensimmaisen-rivin-sisennys}). Tähdetön komentoversio
...
asioita käsitellään tarkemmin luvussa \ref{luku/yla-ala-tunnisteet}.
...
\end{koodilohko}
  \caption{Sisällysluettelon sivutyylin muuttaminen kokonaan
    ...
    ja \luokka{book}}
  \label{esim/sisallysluettelo-empty}
\end{esimerkki*}
...
Esimerkistä \ref{esim/sisallysluettelo-empty} selviää, miten se tehdään.
...
\ref{luku/pystysuuntaiset-valit}), mahdolliset kirjainperheeseen ja
...
\item [parskip] Pystysuuntainen mitta ja väli, joka ei liity pelkästään
  ...
  välinen etäisyysmitta (luku \ref{luku/pystysuuntaiset-valit}). Mitta
...
määrittelyä käsittelevästä luvusta \ref{luku/komennot-maarittely}.
...
\ref{luku/pystysuuntaiset-valit}. Taulukolle tulee oletuksena sama
sisennys kuin tekstikappaleiden ensimmäisellä rivillä on eli mitta
\mitta{parindent} (luku \ref{luku/ensimmaisen-rivin-sisennys}). Jos
...
Saraketyyppi~\koodil{p} (taulukko \ref{tlk/taulukko-sarakemerkit}) on
...
saraketyypit \koodil{lcr} (taulukko \ref{tlk/taulukko-sarakemerkit})
...
paketin\avctan{xcolor} (luku \ref{luku/korostus-varit}) komentojen
...
luvussa \ref{luku/hierarkkiset-laskurit}.
...
\komento{renewcommand} (luku \ref{luku/komennot-maarittely}). Näiden
vaikutuksen voi poistaa kokonaan leijuvan ympäristön valitsimella
\koodil{!} (taulukko \ref{tlk/leijuosat-sijoittelukirjaimet}).
