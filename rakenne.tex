...
perustyypille: Ympäristö \ymparistom{itemize} tekee numeroimattoman
luetelman, jonka jokainen kohta merkitään samanlaisella merkillä,
esimerkiksi luetelmaympyrällä~(\textbullet). \ymparistom{enumerate}
puolestaan on numeroitu luetelma, eli luetelman kohdat saavat
järjestysnumeron tai muun järjestystä ilmaisevan merkinnän kuten
kirjaimen tai roomalaisen numeron. Ympäristö \ymparistom{description}
luo määritelmäluetelman, jossa luetellaan käsitteitä ja niiden
määritelmiä. Tämä on käytännössä sama kuin tekstikappaleen riippuva
sisennys (luku \ref{luku:riippuva_sisennys}), joka alkaa määriteltävällä
ilmauksella.

Edellisten perusluetelmien lisäksi on olemassa myös yleinen luetelmien
rakenteluun tarkoitettu ympäristö \ymparisto{list}, jolla voi tehdä
suunnilleen mitä tahansa luetelmiin tai tekstikappaleisiin liittyviä
rakenteita. Teknisesti \ymparisto{list} sisältää kaikki tarvittavat
...
Luetelmien perusajatus on samanlainen: luetelmaympäristön sisällä
käytetään \komentom{item}\-/ komentoa, joka aloittaa uuden
luetelmakohdan. Komennolle ei tarvitse antaa argumenttia, vaan se lisää
automaattisesti uuden luetelmamerkin. Seuraavassa on esimerkki
...
\begin{koodilohko}
  \begin{description}
  \item[Tex] Tekstin ladontaan erikoistunut ohjelmointikieli.
...
luetelmaympäristön. Sisäkkäin voi olla neljä luetelmaa.

Latex sisentää sisäkkäiset luetelmat automaattisesti ja vaihtaa eri
tasoilla luetelmakohtien merkkiä tai numerointitapaa. Esimerkiksi
ulommaisin \ymparisto{itemize}\-/ ympäristö käyttää
...
Luetelmamerkkejä ja luetelmien numerointitapoja voi muuttaa.
Ympäristössä \ymparisto{itemize} luetelmamerkit tulevat komennosta, joka
alkaa kirjaimilla \komentox{label\-item} ja jatkuu luetelman tasoa
ilmaisevalla roomalaisella numerolla \koodi{i}\==\koodi{iv}. Komennon
voi määritellä uudelleen haluamallaan tavalla. Seuraava esimerkki
näyttää, kuinka \ymparisto{itemize}\-/ ympäristön eritasoiset
luetelmamerkit muutetaan. Samassa ovat niiden oletusarvot.
...
Myös numeroidun \ymparisto{enumerate}\-/ ympäristön numerointitapaa voi
muuttaa jokaisella tasolla. Numeroidut kohdat tulevat komennosta, joka
alkaa kirjaimilla \komentox{label\-enum} ja jatkuu luetelman tasoa
ilmaisevalla roomalaisella numerolla \koodi{i}\==\koodi{iv}.
Numeroidussa luetelmassa käytetään laskureita \laskuri{enumi},
\laskuri{enumii}, \laskuri{enumiii}, \laskuri{enumiv}, joten
luetelmakohtien täytyy latoa näiden laskurien arvo jossakin muodossa.
Seuraavassa on esimerkki numeroidun luetelman eritasoisten kohtien
muuttamiseksi ja samalla niiden oletusarvot:
...
Numeroiduista luetelmakohdista huolehtivat laskurit nollataan aina
ympäristön alussa. Laskurin voi kuitenkin asettaa haluamaansa arvoon
\ymparisto{enumerate}\-/ ympäristön sisällä. Seuraavassa on tästä
esimerkki:
...
\begin{koodilohkosis}
  \begin{enumerate}
  \setcounter{enumi}{3}
  \item Tämä onkin luetelman kohta 4.
  \item Tässä vielä kohta 5.
  \end{enumerate}
\end{koodilohkosis}
...
\subsection{Luetelmien yleistyökalu}
\label{luku:list-ymparisto}

...

\input{kuva-list-mitat.tex}
