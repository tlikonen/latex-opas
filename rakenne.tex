...
Esimerkiksi otsikot, taulukot tai leijuvat osat saa erottumaan selvemmin
leipätekstistä, kun niiden toteutuksessa käyttää värejä. Sen sijaan
leipätekstin sisällä värien käyttö on ehkä liian voimakas tehokeino.
Värikäs leipäteksti voi näyttää rauhattomalta.
...
Seuraavassa on esimerkki oman nimetyn värin määrittelemisestä ja väri
käytöstä.

\komentoi{definecolor}
\komentoi{textcolor}
\begin{koodilohkosis}
\definecolor{korostus}{rgb}{1,.2,.2}
