...
tuottamaa näppäimistöltä tai tekstieditorin toimintojen avulla.
Matematiikkatilan erikoismerkkejä on koottu oheisiin taulukoihin
(\ref{tlk/matem-kreikk}--).
...
\leijutlk{
  ...
  \begin{tabular}{*{2}{cl}}
    ...
    \rivi{\overline{AB}}{overline}
    & \rivi{\underline{AB}}{underline} \\

    \rivi{\overbrace{AB}}{overbrace}
    & \rivi{\underbrace{AB}}{underbrace} \\
