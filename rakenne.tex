...
otsikoiden yhteydessä luvussa \ref{luku:otsikot}.
...
eritasoisilla otsikoilla. Varsinaisten sisältölukujen lisäksi teoksessa
voi olla erilaisia liite- tai luettelosivuja. Toisaalta lyhyempi
artikkeli tai muu teksti sisältänee vain yhden- tai kahdentasoisia
otsikoita. Tässä alaluvussa käsitellään juuri tämäntyyppisiä asioita eli
tekstikappaletta suurempien kokonaisuuksien jäsentämistä.

Jos dokumentissa tarvitaan vähänkään otsikoita, kannattaa ladata mukaan
...
sisällysluettelossa olevat otsikot ovat automaattisesti myös linkkejä,
joilla hypätään kyseiseen lukuun. \paketti{hyperref}\-/ pakettia ja
pdf\-/ tiedoston ominaisuuksia käsitellään tarkemmin luvussa
\ref{luku:pdf_asetukset}.

\subsection{Dokumentin perustiedot ja kansisivu}
\label{luku:kansisivu}

Latex\-/lähdedokumentin alussa -- ennen \ymparisto{document}\-/
ympäristön alkua -- kannattaa lähes aina ilmaista dokumentin perustiedot
eli teoksen nimi, tekijä ja päiväys. Ne ilmaistaan seuraavilla
komennoilla:
...
\komentoi{date}
\begin{koodilohkosis}
  \title{Käytännöllistä Latexia} % teoksen nimi
  \author{Teemu Likonen}         % tekijöiden nimet
  \date{\today}                  % päiväys
\end{koodilohkosis}

Edellisen esimerkin komennot eivät vielä kirjoita mitään tekstiä itse
ladottavaan dokumenttiin. Komennot vain tallentavat perustiedot muistiin
mahdollista myöhempää käyttöä varten. Ne päätyvät myös ladotun pdf\-/
tiedoston sisäisiin tietoihin, jos \paketti{hyperref}\-/ paketti on
ladattuna, kuten .
...
% Tässä puhutaan väliotsikoista. Näitä komentoja ei käytetä pääotsikon
% tekemiseen. Latex-olettaa, että aina ennen alemman tasoista komentoa
% (\subsection) on ollut ylemmäntasoinen komento (\section).
% otsikkokomennot, otsikkotasot, secnumdepth, tocdepth
