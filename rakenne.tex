...
Esimerkistä selvinnee, miten \komento{titlecontents}\-/ komennolla
määritellään luettelokohdan vasemman sisennyksen mitta, yläpuolinen ja
alapuolinen väli (\komento{addvspace}), mahdolliset ulkoasuun
vaikuttavat komennot kuten \komento{rmfamily}, \komento{bfseries} ja
\komento{large}.
...
pisteviivan otsikkotekstin ja sivunumeron väliin. Latexin
...
tarkemmin luvussa \ref{luku:laatikot}. Makropaketin \paketti{titletoc}
ohjekirjassa on paljon muitakin toimintoja, komentoja ja esimerkkejä
sisällysluetteloiden ehostamiseen.
