...
ladottavan sisällön. Seuraavassa esimerkissä on kolme erityyppistä
solmua:

\begin{koodilohkosis}
\begin{tikzpicture}[x=1mm, y=1mm]
  \node at (0,0) [draw=red, rectangle, rounded corners=3bp] {vasen};
  \node [color=blue] at (30,0) {keski};
  \node at (60,0) [draw, circle, inner sep=0bp, fill=yellow] {oikea};
\end{tikzpicture}
\end{koodilohkosis}
