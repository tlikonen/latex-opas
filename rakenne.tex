...
omassa ohjekirjassa on reilu kaksisataa sivua, joten tässä oppaassa
esitellään vain perusasioita.

\begin{esimerkki*}
  % Tarvitaan indeksikomennot
...
\begin{frame}[c]
  ...
  Sisältö keskitetty pystysuunnassa.
...
\end{koodilohko}
  ...
  \caption{\paketti{beamer}\-/ paketin avulla tehdyn diaesityksen runko}
