...
sekaan tiettyyn kohtaan. Ne ''leijuvat'' irrallaan tekstistä eli ovat
muun tekstin ulkopuolella. Latex huolehtii niiden sijoittamisesta.
Leijuvilla osilla on yleensä kuvateksti, jonka alussa on sen tyyppi ja
numero, esimerkiksi ''\figurename~1'' tai ''\tablename\ 4.2''. Näiden
perässä on varsinainen kuvateksti, joka kertoo kyseisen leijuvan osan
sisällöstä tai merkityksestä. Leipätekstistä voi viitata leijuviin osiin
...
tyyppi \koodil{lof} (\englantik{list of figures}) on kuville.
