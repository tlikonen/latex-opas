...
\paketti{amsmath}.\avctan{amsmath} Esimerkiksi \mymparisto{align}\-/
...
\mkomento{quad}\-/ komento, joka latoo pienen vaakasuuntaisen välin.
...
\subsection{Erikoismerkkejä ja operaattoreita}
...
Binäärirelaatiot ja operaattorit ovat puolestaan taulukoissa
\ref{tlk/matem-bin-relaatiot}, \ref{tlk/matem-bin-oper} ja
\ref{tlk/matem-suuret-oper}.
...
\leijutlk{
  \providecommand{\rivi}{}
  \renewcommand{\rivi}[3]{$#1$ & \mkomento{#2}\mkomentoarg{#3}}

  \begin{tabular}{*{3}{cl}}
    \toprule

    \rivi{\grave a}{grave}{a}
    & \rivi{\ddot a}{ddot}{a}
    & \rivi{\hat a}{hat}{a} \\

    \rivi{\acute a}{acute}{a}
    & \rivi{\check a}{check}{a}
    & \rivi{\widehat{aaa}}{widehat}{aaa} \\

    \rivi{\breve a}{breve}{a}
    & \rivi{\dot a}{dot}{a}
    & \rivi{\tilde a}{tilde}{a} \\

    \rivi{\bar a}{bar}{a}
    & \rivi{\mathring a}{mathring}{a}
    & \rivi{\widetilde{aaa}}{widetilde}{aaa} \\
...
\leijutlk{
  ...
  \caption{Matematiikkatilan binäärirelaatiot. Negaation saa
    kirjoittamalla komennon eteen \mkomento{not}}
  \label{tlk/matem-bin-relaatiot}
}
...
\leijutlk{
  ...
  \begin{tabular}{*{3}{cl}}
    ...
    \begin{tikzpicture}
      \draw [rotate=45] (0,0) rectangle (.6ex,.6ex);
    \end{tikzpicture}
    & \mkomento{diamond}
    & \rivi{\amalg}{amalg}
  ...
  \caption{Matematiikkatilan binäärioperaattorit ja muita symboleja}
  \label{tlk/matem-bin-oper}
}

\leijutlk{
  \providecommand{\rivi}{}
  \renewcommand{\rivi}[2]{\large{$#1$} & \mkomento{#2}}
  ...
  \caption{Matematiikkatilan suurikokoiset operaattorit}
  \label{tlk/matem-suuret-oper}
}

\leijutlk{
  \providecommand{\rivi}{}
  \renewcommand{\rivi}[2]{$#1$ & \mkomento{#2}\mkomentoarg{AB}}
  \renewcommand{\arraystretch}{1.5}

  \begin{tabular}{*{2}{cl}}
    \toprule

    \rivi{\overrightarrow{AB}}{overrightarrow}
    & \rivi{\overleftarrow{AB}}{overleftarrow} \\

    \rivi{\underrightarrow{AB}}{underrightarrow}
    & \rivi{\underleftarrow{AB}}{underleftarrow} \\

    \rivi{\overleftrightarrow{AB}}{overleftrightarrow}
    & \rivi{\underleftrightarrow{AB}}{underleftrightarrow} \\

    \bottomrule
  \end{tabular}
}{
  \caption{Matematiikkatilan nuoliaksentteja}
  \label{tlk/matem-nuoliaksentit}
}
...
\leijutlk{
  ...
  \caption{Matematiikkatilan nuolet}
  \label{tlk/matem-nuolet}
}
