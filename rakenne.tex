...
alaviitekappaleita. Erotinviiva poistetaan paketin valitsimella
\koodi{norule}. Samalla pystysuuntainen väli hieman kasvaa.
...
Paketin lataamisen yhteydessä voi antaa useita pilkulla erotettuja
valitsimia. Valitsin \koodi{perpage} numeroi alaviitteet
sivukohtaisesti, eli niiden laskuri nollautuu aina sivun vaihtuessa.
Valitsin \koodi{bottom} pakottaa alaviitteen aina sivun alareunaan.
Oletusasetuksilla alaviite voi sijoittua joskus ylemmäksi, jos sivun
alaosaan ladotaan leijuva osa tai jos sivun alareunan tasaaminen on pois
päältä (\komento{raggedbottom}, luku \ref{luku/sivunvaihdot}).
...
\koodi{onecolumn} (oletus) tai \koodi{twocolumn}. Kesken dokumentin
tilaa voi vaihtaa komennoilla \komento{onecolumn} ja
\komento{twocolumn}. Kahden palstan tilaa käsitellään luvussa
