...
komennon määritelmä on suunnilleen seuraavanlainen:
...
latoa kaikki luetelmamerkit tietynlaisella fontilla. Varsinkin
määritelmäluetelmissa (luku \ref{luku:luetelma_perus}), joissa
luetellaan käsitteitä ja niiden määritelmä, voidaan haluta, että
...
\item [labelwidth] Luetelmamerkin leveys. Merkki ladotaan oletuksena
  ...
  että luetelmamerkki mahtuu. Luetelmamerkin alueen vasen reuna
  sijaitsee kohdassa, jonka voi laskea seuraavasta kaavasta:
  \mitta{leftmargin} + \mitta{itemindent} − \mitta{labelsep} −
  \mitta{labelwidth}. Mikäli haluaa, että luetelmamerkin vasen reuna on
