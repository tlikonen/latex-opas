...
ei ole vielä kirjan kansi, koska kirjapainossa kannet lisätään ikään
kuin tekijöiden työn ympärille.%
...
komento \komentox{list\-of\-esi\-merk\-kis} (vrt.
\komento{listoftables}), jota voi käyttää luettelon (luku
\ref{luku:leijuosat_luettelot}) latomiseen tämäntyyppisistä leijuvista
osista.
...
\leijutlk{
  ...
  \begin{tabular}{ll}
    ...
    \rivi{chapterlistgaps}{luettelossa väli päälukujen välissä
...
\label{luku:leijuosat_sijoittelu}. Käytännössä ne ovat tiettyjä
kirjaimia, joilla vaikutetaan leijuvan osan sijoitteluun. Oletusarvo on
\koodil{tbp}.
...
\subsection{Leijuvien osien luettelot KESKEN}
...
\komentom{listoffigures} kuvaluettelo. Nämä muistuttavat
sisällysluetteloita (\komento{tableofcontents}, luku
...
\begin{koodilohko}
\titlecontents{table}                       % taulukkoluettelo (table)
[8mm]                                       % vasen sisennys (mitta)
...
sisällysluetteloidenkin: ladataan paketti
...
Luetteloiden otsikot tulevat kieliasetuksista ja komennoista
\komento{listtablename} ja \komento{listfigurename}, jotka kirjoittaja
voi määritellä uudestaan. Järkevää on tehdä se lähdedokumentin
esittelyosassa ja käyttää \komento{addto}\-/ komentoa, jolla asetukset
lisätään tietyn kielen asetuksiin.
...
Luetteloihin saa lisättyä omia otsikoita samoilla keinoilla kuin
...
kirjoitetaan kyseisen leijuvan ympäristön nimi, esimerkiksi
\ymparisto{table} tai \ymparisto{figure}. Komennon kolmas argumentti on
luetteloon lisättävä merkintä.

% Omat leijuvien osien luettelot noudattavt ilmeisesti figure-luettelon
% ulkoasua, koska ne sisäisesti käyttävät komentoa \listoffigures (ks.
% newfloat-paketin ohjeet).
...
tai omalle sivulleen, jossa ei ole leipätekstiä lainkaan. Sijoitteluun
voi vaikuttaa ympäristön valinnaisen argumentin avulla:
