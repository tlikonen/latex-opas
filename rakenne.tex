...
monimutkaisia fontti- eikä muotoilukomentoja, vaan mieluiten vai otsikon
teksti. Typografinen muotoilu tehdään muilla keinoilla, joita esitellään
alaluvussa \ref{luku:otsikot_ulkoasu}. Yksinkertaiset korostuskomennot
tai tavutusvihjeet (\komento{-}) kuitenkin toimivat yleensä.
...
syntyviä sisällysluettelon kohtia. Komento \komento{phantomsection}
lisää pdf\-/ tiedostoon näkymättömän ankkurin tähän kohtaan
dokumentissa. Sitä tarvitaan, jotta sisällysluettelon merkintä toimisi
...
Vastaavasti \komento{subsection}\-/ otsikko latoo numeron käyttämällä
...
komento \komento{arabic} latoo laskurin arabialaisilla numeroilla.
...
Monimutkaisemmat muotoiluasetukset saa toteutettua komennon
''tähdettömällä'' versiolla \komento{titleformat}. Se voi olla tarpeen
esimerkiksi \komento{chapter}\-/ tasoisissa otsikoissa, joissa halutaan
ehkä muotoilla päälukujen aloitussivua enemmänkin. Tämän
\komento{titleformat}\-/ komentoversion monista argumenteista ja
asetuksista kannattaa lukea \paketti{titlesec}\-/ paketin ohjekirjasta.

Luvun numeroinnin (1.1, 1.2 jne.) tyyliin vaikutetaan komennolla
\komentom{titlelabel}. Komento suoritetaan yleensä vain kerran, ja se
vaikuttaa kaikentasoisiin otsikoihin.
...
suomen kieliasetuksista. Kaikkien kielten asetukset nimittäin
määrittelevät komennon \komentom{partname} siten, että se sisältää ja
latoo kyseiseen kieleen sopivan ilmauksen.
...
komennosta \komentom{chaptername}. Jos omassa dokumentissa --
esimerkiksi romaanissa -- haluaa kutsua teoksen osia ja päälukuja
joksikin muuksi, voi määritellä mainitut komennot uudelleen, esimerkiksi
seuraavasti:
...
tulevat voimaan samalla kun suomen kieliasetuksetkin. \komento{addto} on
