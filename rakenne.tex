...
uudelleen. Jos esimerkiksi \komento{section}\-/ tasoiset luvut halutaan
ilmaista kirjaimin (A, B, C jne.), tehdään se seuraavan esimerkin
mukaisesti. Esimerkissä käytettävä komento \komento{Alph} latoo laskurin
arvon versaalikirjaimin.
...
käyttö on hankalampaa eikä se toimi kaikilla otsikkotyypeillä. Perus
Latexin omiin keinoihin voi tutustua esimerkiksi epävirallisen Latex\-/
...
''tähdettömällä'' versiolla \komento{titleformat}. Se on tarpeen
esimerkiksi \komento{chapter}\-/ tasoisissa otsikoissa, joissa halutaan
ehkä latoa eri riveille erityylinen luvun numero (''Luku~3'') ja luvun
nimi. \komento{titleformat}\-/ komennon monista argumenteista ja
asetuksista kannattaa lukea \paketti{titlesec}\-/ paketin ohjekirjasta.

Luvun numeroinnin (1.1, 1.2) tyyliin vaikutetaan komennolla
