...
näkyvyy sivunumero, vaikka sitä ennen olisikin asettanut sivutyyliksi
\koodi{empty}. Monisivuisen sisällysluettelon seuraavilla sivuilla sen
sijaan noudatetaan aiemmin \komento{pagestyle}\-/ komennolla asetettua
sivutyyliä.
...
esimerkin komennolla, joka lisää ylimääräisen \komento{thispagestyle}\-/
komennon sisällysluetteloa varten tehtävään väliaikaiseen \koodi{toc}\-/
...
sisällysluettelon latomiskomento sijoitetaan. Esimerkistä
\ref{esim:sisallysluettelo_empty} selviää, miten se tehdään.
...
\caption{Sisällysluettelon sivutyylin muuttaminen kokonaan
  ...
  määritellä väliaikaisesti uudestaan}
