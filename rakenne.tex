...
\noindent
\paketti{biblatex}\-/paketti\avctan{biblatex} sisältää valtavan paljon
asetuksia ja mahdollisuuksia lähdeluettelon ja \=/viitteiden ulkoasun
säätämiseen. Esimerkiksi komennolla \komento{DeclareBibliographyDriver}
voi ottaa täysin haltuun, miten tietty teostyyppi ladotaan
lähdeluetteloon. Komennolla \komento{DeclareSortingTemplate} voi
määritellä omia aakkostustapoja. Lisätietoa saa paketin ohjekirjasta.
...
\paketti{amsmath}\avctan{amsmath}. Esimerkiksi \mymparisto{align}\-/\ ja
...
\paketti{latexsym}\avctan{latexsym} ja
\paketti{amsmath}\avctan{amsmath}.
