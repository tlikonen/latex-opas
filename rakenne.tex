...
\ymparisto{list}\-/ ympäristöä hyödynnetään ympäristön määritelmässä.
Omien ympäristöjen tekemistä käsitellään tarkemmin luvussa
\ref{luku:ymparistot}, mutta tämänkin alaluvun loppupuolella on
...
koodia, jonka avulla ladotaan luetelmakohdan merkki. Numeroimattomassa
...
luetelmassa se voisi sisältää komennon, joka latoo jonkin laskurin
arvon. Seuraava esimerkki latoo \laskuri{enumi}\-/ laskurin arvon
arabialaisilla numeroilla ja sen perään pisteen. Luetelmamerkit
näyttävät siis seuraavalta: ''1.'', ''2.'', ''3.'' jne.
...
Aiemmassa \ymparisto{list}\-/ ympäristön rakenne\-/esimerkissä toinen
argumentti ''\koodi{ase\-tuk\-set}'' sisältää mitä hyvänsä koodia, jolla
ympäristö asetetaan sopivanlaiseksi. Tyypillisesti siinä määritellään
käytettävä luetelmalaskuri sekä asetetaan luetelman ulkoasuun
vaikuttavat mitat sopivaksi.
...
myös eräitä luetelman sisäisiä mittoja.
