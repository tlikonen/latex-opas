...
Käytä kunnollista teksti\-editoria. Sellaisia tehtiin ennen vanhaan
...
Hyvän teksti\-editorin ja PDF\-/katselimen kanssa työskentely on
sujuvaa. Tietty näppäinkomento editorissa tallentaa ja kääntää
...
kuin tallentaa tiedosto teksti\-editorista, ja tarkkailutilassa oleva
...
väliaikaistiedostot (\koodi{log, aux, out} ym.), ja jälkimmäinen rivin
...
väliaikaistiedostojen päätteitä. Yleiset väliaikaistiedostot
(\koodi{log, aux, out} ym.) on Latexmk\-/ohjelmalla jo tiedossa, mutta
tällä asetuksella mukaan voi lisätä muitakin.
