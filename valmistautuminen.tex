...
erilaisia Latexin toteutuksia ja tietokoneohjelmia (\koodi{xelatex},
\koodi{lualatex}), joilla lähdedokumentti käännetään.\footnote{Englannin
...
kääntää pdf\-/tiedostoksi\footnote{PDF = Portable Document Format}
kummalla tahansa.
